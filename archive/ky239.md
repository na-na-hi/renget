...
> NSFW?
**yes**. no strings attached. Locals are absolutely unfiltered so you can do whatever you want. mind that some Locals may have inner filters because they were trained on filtered materials (for example, none-finetuned *Llama 2 is censored*)
***
...
first you have a **basic (aka foundation, pretuned) model** - which is a model trained on optimized dataset. the most known fundamental model - `Llama`, made by Meta; other examples - `Falcon`, `Mistral`, `GPT-2/J`, `MPT`...
...
#### Notebook
==**--\> #1**==. 
download [Notebook](https://cdn.discordapp.com/attachments/1152584624367734907/1162224482673500210/LunarArtist_07_13.ipynb) *(all credits in the notebook)*
