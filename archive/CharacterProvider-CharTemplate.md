...
##### Empty template for a %orange%Character Card%%
...
Make sure to include colloquialisms. You may write only actions, making your character mute in certain situations. Try to provide casual speech, not catch phrases. Provide context for clarification.
