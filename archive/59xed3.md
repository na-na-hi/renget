...
If your concerns are more on the monetization and copyright side, you'll have to ask a lawyer, but the entire thing looks grim if you ask me, I wouldn't plan any hustle around this.
...
* Poorly trained LyCORIS cannot be salvaged easily with tricks from the above-mentioned extensions (such as LoRA Block Weight's "OUTALL").
...
It is very useful for smaller elements, styles and backgrounds, but it isn't as good for characters. 
For styles, concepts, and other things, it's very useful because of the tiny sizes, but for characters it doesn't exactly increase *quality*. 
...
Seems there's still no Kromer model. My faith in humanity has been restored.