...
2. Click 'Edit'
3. Add your commands after the `set COMMANDLINE_ARGS-` line (line 7)  
Example of my commandline args:
	``` python
	@echo off
...
- If you're running out of vram (memory), right click `webui-user.bat`, click 'Edit', and add " --med-vram " or " --low-vram " (remove the quotations) after 'set COMMANDLINE_ARGS=' (line 7) in webui-user.bat. Choose the former if possible
...
If anything breaks, `Ctrl + C` in your Command Prompt window to shut down running processes
...
- Sampling method: Each one generates images differently. Test it out yourself to see which you like. For comparisons, check out the [Goldmine: Comparisons](https://rentry.org/sdgoldmine#comparisons) 
...
- You can go above 75 tokens. The webui will pad the last 20-ish tokens with blank tokens if this happens (unless this was changed in the settings). When the 76th token is reached, the weights reset.
	- Example: 1girl (1), apple (2), ..., banana (54), grapes (55), pear (56), mango (57) ... , orange (74), plum (75), tangerine (1) --> the last 20 tokens are padded --> banana (54), grapes (55), , , , , , , , , , , , , , , , , , , , pear (1), mango (2)
		...
		- The spaces between the commas are what counts toward the token limit
...
Another guide: https://cdn.discordapp.com/attachments/1011105234820542554/1045325024321613884/DR.Derps_training_guide_and_insights_1.pdf
...
Goldmine (Everything else): https://rentry.org/sdgoldmine
Reddit: https://www.reddit.com/r/StableDiffusion

Work in progress:  
Linux + AMD setups  
More training information
update this because its probably outdated  
