...
I've recently discovered a very useful LoRA that you might want to install. It's named [Add Detail/Detail Tweaker](https://civitai.com/models/58390) and it'll improve the quality of some of your generations. I say some, because it often depends on what your prompt is if it's good to use or not. Try playing around with it and see if it improves your generations or not.
