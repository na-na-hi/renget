...
-> **Zipacna (Mayan)** - Siege's Jungle Boss /  Wild Juggernauts. <-
   ...
   *Mirroring this myth, on the Mayan-side of the Siege map's successor (Slash) next to the in-lane Juggernaut spawn, a gigantic crab can be seen at times hidden in a waterfall-canyon (presumably why he was gone in Slash, having been defeated by Xbalanque and Hun'Ahpu). Does this make the game R-rated? You decide.*
