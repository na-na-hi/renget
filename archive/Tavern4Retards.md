...
### Proxy link sharing!
Now that we're all enjoyers of keys sharing. I'll just quickly explain how to find the keys.
>Anon posts key: https://huggingface.co/spaces/whocars123/oai-proxy
>Dumb anons tries it, fail and cry in thread about it
>Smart anon's clicks the link and finds "openai": "https://whocars123-oai-proxy.hf.space/proxy/openai"
>Regular /aicg/ Anon's knows that you add "/v1" to that link.
>Real link is "https://whocars123-oai-proxy.hf.space/proxy/openai/v1"
The Key takeaway here is to look for huggingface links, navigate to the site and find the real link and add /v1 to them.
...
Also for https://alwaysfindtheway.github.io/  -- I've made CSS and Tampermonkey script which 'cleans' it up a bit, highlights the GPT4 keys and Refreshes every 10 minutes. You can find it here: https://rentry.org/4RetardsUtility
