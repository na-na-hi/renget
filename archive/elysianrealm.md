...
​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​
[**Old builds can be found here on HoYoLAB**](https://www.hoyolab.com/accountCenter/postList?id=7866431)
...
2nd | Pardofelis1 | Both damage boosts, HPSP cap up are the key choices, unlock nexus 
Optional | Griseo1 | Red Yellow Grey are the key choices, don't need nexus

!!! info Recommended to swap sigil on 5F Rotation:  tap weapon around every 12s, use ultimate when available, use basic atk rest of the time
...
->https://www.pixiv.net/en/artworks/112620932<-
...
Optional | Kosma1 | Ultimate, basic ATK, evasion, shieldbreak damage are the key choices, individual is fine, nexus is better; can also pick Griseo Red Yellow Grey as reinforcement

!!! info Recommended to swap sigil on 5F; if Griseo Red is obtained then tap weapon active to apply paint Rotation : Evade - hold basic - tap glowing basic, repeat, use ultimate whenever available

#->Lunar Vow: Crimson Love weapon<-
->![lvwep](https://i.imgur.com/vt82vuA.png)<-
->https://www.pixiv.net/en/artworks/112461209<-
...
!!! info Rotation : Use ultimate whenever available, tap weapon multiple times to spend bar - then long press weapon to recover bar(single Ego) / use ultimate (double ego); recommended to swap sigils on 5F
...
Priority | Signet | Details
------ | ------ | ------
1st | Kalpas1 | Both damage boosts, HP cap up, vulnerability are the key choices, unlock nexus; recommended to pick all enhanced
2nd | Sakura1 |  Vulnerability, TDM, evasion+1 are the key choices, unlock nexus 
...
!!! info Recommended to have full signature before attempting, otherwise performance is not good; recommended to reset for  Inner Blaze on 2F; recommended to swap sigil on 6F, roll Kalpas on 7th; use Kevin support on 4F 7F wave 3
...
->![horbde](https://i.imgur.com/UcYNSai.png)<-
...
!!! info Rotation :  Dodge at start then use basic ATKs to charge the bar, then use combo ATK, and ultimate whenever available; if have Griseo Red, only tap weapon skill once; recommended to swap sigil on 5F; use Kevin support on 4F and 7F wave 3
...
!!! info Recommended to swap sigil on 6F after rolling Su on 7F; don't be too far from enemies, otherwise Su's explosion will be out of range; put Mobius support skill in the middle of enemies
...
2nd | Pardofelis1 | HPSP cap up, both damage boosts are the key choices , unlock nexus
2nd | Sakura2 | Vulnerability, TDM, evasion+1 are the key choices,  unlock nexus
Optional | Eden1 | Both damage boosts, starting SP are the key choices, don't need nexus; can also pick Aponia 6,  Hua2 nexus (Both damage boosts, breach) as reinforcement

!!! info Recommended to swap sigil on 6F, roll Kalpas on 7F; use Kevin support for 4F and 7F wave 3
...
!!! info Recommended to reset for Recursion on 2F; recommended to swap sigil on 5F
...
!!! info Recommended to reset for Recursion on 2F; must pick both combo boosts from Su; recommended to swap sigil on 6F, roll Vill-V on 7F
...
!!! info Recommended to swap sigil on 6F, roll Su on 7F; recommended to bring VKE before 12F, which breaks shields and reduces DMG taken
...
!!! info Starting with only Condescension is fine; recommended to swap sigil on 6F, roll Su on 7F; can fight Andrius
...
##->Ego Signets<-
 Lethal Smite 雷殛 | Expungement 断灭 | Ultra 极意 | Nature 本然  |  Inscription 铭印 
:-: | :-: | :-: | :-: | :-: 
**Start** | **1st** | 2nd | No | No 
...
1st | Kalpas1 | Both damage boosts, HP cap up are the key choices, can pick vulnerability, unlock nexus;  can pick Burden, TDM from enhanced
2nd | Hua2 | Both damage boosts, breach are the key choices, unlock nexus 
2nd | Su1 | Both combo boosts, vulnerability, TDM are the key choices, must pick at least breach, can pick vulnerability 
...
!!! info Recommended to swap sigil on 5F, recommended to reset for Expungement on 2F
...
2nd | Kalpas1 | Both damage boosts, vulnerability, HP cap up are the key choices, unlock nexus 
2nd | Griseo1 | Red Yellow Grey are the key choices, unlock nexus 
...
!!! info Recommended to reset for Sharp Flames on 2F; 3 charge attacks for every 1 ultimate; recommended to swap sigil on 5F
...
!!! info Lower level setups recommended to reset for Sharp Flames on 2F; 4F use Kevin's support to deal with 3rd wave; recommended to swap sigil on 6F, roll Su on 7F; after getting Kevin use 1 ultimate per 3 charge attacks
...
Priority | Signet | Details
------ | ------ | ------
1st | Vill-V1 | 3 1 5 2 are the key choices, unlock nexus 
...
!!! info Recommended to reset for Time Crystal on 2F
...
!!! info For single Ego start with Succession, lower level setup must reset for Time Crystal on 2F; If able to get Su's breach on 5F, swap sigil on 6F, otherwise continue picking Su
...
2nd | Hua2 | Breach, both damage boosts are the key choices, unlock nexus
2nd | Kalpas1 | Both damage boosts, HP cap up, vulnerability are the key choices, recommended to pick Burden, TDM from enhanced
2nd | Griseo1 | Red Yellow Grey are the key choices, unlock nexus
Optional | Su2 | Vulnerability, TDM, +25 combo, are the key choices, individual is fine, nexus is better; can also pick Pardofelis1 nexus ( both damage boosts, HPSP cap up) as reinforcement

!!! info After getting Eden starting SP, use LE immediately at the start then ulti to activate Eden; recommended to swap sigil on 5F; leave around 2k HP to leave a margin of error, swap to BKE at 2nd shop to help vs Heimdall 
...
!!! info After 4F, use LE then ultimate asap, get free SP; recommended to swap sigil on 5F
...
!!! info Recommended to only try this with full signature, otherwise use fast ult build. Rotation : Use evasion and weapon active whenever available, charge attack the rest of the time, use 3 charge atk per 1 weapon; recommended to swap sigil on 6F, roll Kalpas on 7F, use Kevin support on 4F and 7F wave 3
...
2nd | Pardofelis1 | HPSP cap up, both damage boosts are the key choices, unlock nexus
Optional | Vill-V2 | 2 5 3 are the key choices, individual is fine, nexus is better; can also pick Sakura vulnerability, TDM as reinforcement 

!!! info If dying easily, can pick Kalpas2 to preserve damage boost; recommended to swap sigil on 5F
...
2nd | Griseo1 | Red Yellow Black are the key choices, unlock nexus
Optional | Kalpas1 | Both damage boosts, HP cap up, are the key choices; individual is fine, nexus is better; can pick Burden, TDM from enhanced
Optional | Sakura1 | Vulnerability, TDM are the key choices, don't need nexus; can also pick Eden both damage boosts as reinforcement

!!! info Recommended to swap sigil on 5F; try to get Pardofelis breach signet asap; use Griseo's support skill on 3rd wave of 4F; lower level setups are recommended to reset for First Awakening on 2F, higher level setups can pick up if able to
...
!!! info Recommended to swap sigil on 5F; other than Su, rest of signets don't need enhanced; better to unlock more nexus 
...
2nd | Sakura2 | Vulnerability, TDM, evasion+1 are the key choices,  unlock nexus 
2nd | Pardofelis1 | Both damage boosts are the key choices, unlock nexus
Optional | Griseo1 | Red(prioritise to buy in shop) Yellow Grey are the key choices, don't need nexus; can also pick Eden both damage boosts, starting SP, Vill-V 2 3 as reinforcement 

!!! info Recommended to swap sigil on 5F; use Kevin support on 4F wave 3
...
2nd | Su1 | Both combo boosts, TDM, SP are the key choices, unlock nexus; can pick vulnerability from enhanced
2nd | Griseo1 | Red Yellow Grey are the key choices, unlock nexus 
2nd | Pardofelis1 | Both damage boosts are the key choices, unlock nexus 
Optional | Aponia2 | 4 3 1 are the key choices, unlock nexus ; can also pick Eden starting SP as reinforcement 

!!! info Recommended to reset for Nocturne on 2F; SP gained is important; recommended to swap sigil on 5F
...
!!! info Recommended to reset for Nocturne on 2F; recommended to swap sigil on 5F
...
Optional | Griseo1 | Red Yellow are the key choices, unlock nexus 

!!! info Use combo atks without mixing colors; low level runs are not recommended to take Kalpas before 12F; recommended to swap sigil on 6F, roll Kosmos on 7F
...
!!! info For non brick users, refer to previous version for brick; recommended to swap sigil on 5F; if not resetting for Dark Plumes, recommended to pick Eden SP recovery, otherwise go fo more damage
...
2nd | Su1 | TDM, vulnerability, both combo boosts are the key choices, unlock nexus, must pick at least breach, can pick vulnerability
2nd | Sakura2 | TDM, vulnerability, evasion+1, evasion reset are the key choices, unlock nexus 
2nd | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus
2nd | Kosmos1 | Basic ATK, evasion, time extension are the key choices, unlock nexus can also pick Griseo Red as reinforcement

!!! info 1.75, used to unlock stamps in shop, not recommended to use for farming; recommended to swap sigils on 5F
...
Priority | Signet | Details
------ | ------ | ------
1st | Vill-V1 | 5 2 3 are the key choices, can also pick 6 ; must pick at least breach from enhanced, recommended to also pick physical DMG
2nd | Su1 | Vulnerability, 60 combo boost, TDM are the key choices; must pick at least breach from enhanced, recommended to also pick vulnerability 
2nd | Griseo1 | Red Yellow Black Grey are the key choices, unlock nexus 
2nd | Pardofelis1 | Both damage boosts, HPSP cap up are the key choices, unlock nexus
Optional | Kalpas2 | Both damage boosts, HP cap up are the key choices, individual is fine, nexus is better

!!! info Recommended to bring LE at the start; recommended to swap sigil on 6F, roll Vill-V on 7F; if less than SS, recommended to hit 1.75
...
->![hosbrik](https://i.imgur.com/kHCETkY.png)<-
->https://twitter.com/sinn56902487/status/1458382654202470407<-
...
Priority | Signet | Details
------ | ------ | ------
1st | Mobius1 | Both TDMs, vulnerability, reduce support CD are the key choices, recommended to pick Dead, Unknown from enhanced
2nd | Griseo1 | Red Yellow Blue Black Grey are the key choices, recommended to pick all enhanced
2nd | Su1 | Vulnerability,  both combo boosts are the key choices, can pick TDM, unlock nexus 
2nd | Pardofelis1 | Both damage boosts are the key choices, can pick both silver generation(buy from early shop), unlock nexus 
Optional | Aponia2 | 3 4 5 are the key choices, unlock nexus ; can also pick Kosma basic ATK, evasion, ultimate, time extension, vulnerability as reinforcement

!!! info Must have brick, otherwise don't use; recommended to swap sigil on 6F, roll Mobius on 7F
...
!!! info Recommended to reset for Sharp Flames on 2F; after getting Kevin, do 3 charge atks per 1 ulti; recommended to swap sigils on 6F, roll Su on 7F; use Kevin support on 4F 7F wave 3
...
!!! info Recommended to reset for Star Quillon on 2F, if you know how to gather enemies then take Alrescha instead; if able to get Su's breach on 5F then swap sigils on 6F, otherwise continue with Su's sigil
