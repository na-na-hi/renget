...
[Herrscher of Human: Ego ulti](https://rentry.org/ElysianRealm/#herrscher-of-human-ego-ulti)
...
[Herrscher of Origin ulti](https://rentry.org/ElysianRealm#herrscher-of-origin-ulti_1)
[Herrscher of Truth ulti](https://rentry.org/ElysianRealm#herrscher-of-truth-ulti_1)
[Jade Knight](https://rentry.org/ElysianRealm#jade-knight_1)
[Herrscher of Human: Ego ulti](https://rentry.org/ElysianRealm/#herrscher-of-human-ego-ulti_1)
...
[Herrscher of Thunder Narukami](https://rentry.org/ElysianRealm/#herrscher-of-thunder-narukami_1)
[Chrono Navi](https://rentry.org/ElysianRealm/#chrono-navi_1)
[Vermillion Knight: Eclipse charge](https://rentry.org/ElysianRealm/#vermillion-knight-eclipse-charge_1)
...
Priority | Signet | Details
------ | ------ | ------
1st | Vill-V2 | 2 3 4 are the key choices; recommended to pick all enhanced, must pick at least breach
1st | Aponia2 | 1 2 3 are the key choices; recommended to pick all enhanced, must pick at least breach
2nd | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus
Optional | Griseo1 | Red Black are the key choices, don't need nexus
Optional | Eden1 | Both damage boosts are the key choices, don't need nexus; can pick Kalpas vulnerability as reinforcement
...
2nd | Aponia2 | 2 3 4 are the key choices; recommended to pick breach from enhanced
2nd | Su2 | Vulnerability, TDM, SP, both combo boosts are the key choices, unlock nexus
2nd | Eden1 | Both damage boosts are the key choices, unlock nexus; can pick Aria of Dawn
Optional | Sakura1 | Vulnerability, TDM, ATK spd are the key choices, don't need nexus; can also pick Griseo, Kalpas, Kosma signets as reinforcement
...
Time | Emblem 
------ | ------ 
Start | Feast of Emptiness/The Lonely Moon
1st Shop | Veil of Tears/The Lonely Moon
16F | Tin Flask/Dreamful Gold

##->Ego Signets<-
 Finale Moon 终月 | Rift 时隙 | High Flames 决焰 | Clarity 空明 | Condescension 至临
:-: | :-: | :-: | :-: | :-: 
**Start** | **1st** | No | No | No 
...
Priority | Signet | Details
------ | ------ | ------
1st | Pardofelis2 | Both silver gen signets, both damage boosts are the key choices, can pick HP/SP cap up; recommended to pick all enhanced, prioritise vulnerability
2nd | Aponia2 | 3 4 5 6 are the key choices; recommended to pick vulnerability and breach from enhanced
2nd | Kalpas2 | Both damage boosts, vulnerability are the key choices, unlock nexus
2nd | Kevin1 | Both damage boosts, SP regen, are the key choices, unlock nexus; pick 1 breach between Aponia and Kevin
Optional | Griseo1 | Red Yellow Grey are the key choices, don't need nexus; can also pick Vill-V vulnerability, TDM signets as reinforcement
...
Priority | Signet | Details
------ | ------ | ------
1st | Pardofelis2 | Both silver gain signets, both damage boosts are the key choices, can pick HP/SP cap up; recommended to pick all enhanced, prioritise vulnerability
1st | Aponia2 | 3 4 5 6 are the key choices; recommended to pick vulnerability and breach from enhanced
2nd | Griseo2 | Red Yellow are the key choices, don't need nexus
2nd | Kevin1 | Both damage boosts, SP recovery are the key choices, unlock nexus; pick 1 breach from Kevin/Aponia
Optional | Kalpas2 | Both damage boosts, vulnerability are the key choices, unlock nexus; can also pick Vill-V, Eden signets as reinforcement
...
2nd | Kalpas2 | Both damage boosts, HP cap up are the key choices, unlock nexus
2nd | Aponia2 | 1 3 5 are the key choices, unlock nexus; can pick vulnerability from enhanced
Optional | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus; can also pick Vill-V, sakura, or Eden signets as reinforcement
...
------ | ------
0 | RPC-6626 weak to ele
5 | Ultimate Evasion recovers 10 SP
5 | Valk type matching enemy +TDM
15 | Weapon type TDM bonus
...
1st Shop | Rainbow of Absence/Because of You
16F | Tin Flask/Dreamful Gold

##->Ego Signets<-
 Nature 本然 | Lethal Smite 雷殛 | Expungement 断灭 | Inscription 铭印 | Ultra 极意 |  
:-: | :-: | :-: | :-: | :-: 
**Start** | **1st** | 2nd | No | No 
...
Priority | Signet | Details
------ | ------ | ------
1st | Aponia2 | Basic ATK, vulnerability, damage reduction are the key choices; recommended to pick all enhanced, prioritise breach, vulnerability
2nd | Griseo2 | Red Black Yellow Blue are the key choices, recommended to pick all enhanced
2nd | Pardofelis1 | Both damage boosts are the key choices, unlock nexus
Optional | Kalpas1 | Both damage boosts, vulnerability are the key choices, don't need nexus
Optional | Vill-V1 | Vulnerability, elemental DMG are the key choices, don't need nexus; can also pick Eden both damage boosts, Sakura vulnerability as reinforcement
...
**Blessing of Burning Flow 流炎** Evasion can be connected into Guren Flash(evasion skill)  | 2nd
...
Signet | Choice
------ | ------
Kalpas2 | Both damage boosts, vulnerability are the key choices, unlock nexus; If having trouble with 4F recommended to start with double Ego
Aponia2 | 3rd 4th are the key choices; must pick at least breach from enhanced, recommended to pick vulnerability as well

##->Secondary Signets<-
Signet | Choice
------ | ------
Griseo2 | Red Yellow Black Grey are the key choices, don't need nexus; can just buy from shop
Sakura2 | Vulnerability, TDM, evasion +1 are the key choices,, unlock nexus

##->Optional Signets<-
Signet | Choice
------ | ------
Su2 | Vulnerability, TDM, 60 combo are the key choices, don't need nexus; can also pick both damage boosts from Kevin as reinforcement
...
Priority | Signet | Details
------ | ------ | ------
1st | Aponia2 | Ultimate, vulnerability, damage reduction are the key choices, must pick at least 3 signets to recover exhortation; pick at least breach from enhanced, recommended to also pick vulnerability
2nd | Vill-V1 | Vulnerability, 3 TDMs, are the key choices, unlock nexus
...
Optional | Su2 | TDM, vulnerability, 60 combos are the key choices, unlock nexus; can also pick Eden both damage boosts as reinforcement
...
Priority | Signet | Details
------ | ------ | ------
1st | Aponia2 | 1 2 3 are the key choices, unlock nexus, must pick at least breach from enhanced, recommended to also pick vulnerability
1st | Griseo2 | Red Yellow Blue Grey are the key choices; recommended to pick purple, green from enhanced
2nd | Su2 | Vulnerability, TDM, 60 combos are the key choices, unlock nexus
2nd | Kalpas1 | Both damage boosts, vulnerability are the key choices, don't need nexus
Optional | Sakura2 | Vulnerability, TDM are the key choices, don't need nexus; can additionally pick Eden both damage boosts as reinforcement
...
2nd | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus
Optional | Kalpas2 | Can rely on BR to reduce HP; both damage boosts, HP cap up are the key choices, don't need nexus; can also pick Sakura vulnerability, TDM as reinforcement
...
Weapon | Stig
------ | ------
Purana Phantasma: Nighteye | Bronya: N-EX TB + Willows M
...
Priority | Signet | Details
------ | ------ | ------
1st | Vill-V2 | 2 3 are the key choices; recommended to pick breach, vulnerability from enhanced
1st | Hua2 | Breach, both damage boosts are the key choices, unlock nexus
2nd | Griseo2 | Red(buy asap if in shop) Black Yellow Grey are the key choices, don't need nexus
2nd | Aponia2 | 1 4 5 6 are the key choices, unlock nexus; can pick vulnerability from enhanced
2nd | Pardofelis1 | Both damage boosts are the key choices, unlock nexus; can also pick Eden, Su, Kalpas(must unlock nexus) as reinforcement
...
Priority | Signet | Details
------ | ------ | ------
1st | Griseo2 | Red Yellow Black Blue are the key choices, recommended to pick all enhanced
1st | Vill-V2 | 2 3 5 are the key choices; recommended to pick all enhanced, prioritise breach
2nd | Mobius1 | Both TDMs, vulnerability are the key choices, unlock nexus
2nd | Pardofelis1 | Both damage boosts, are the key choices, unlock nexus
2nd | Su2 | TDM, vulnerability, 60 combos are the key choices, don't need nexus; can also pick Sakura vulnerability, Kalpas vulnerability as reinforcement
...
Priority | Signet | Details
------ | ------ | ------
1st | Griseo2 | Red Yellow Blue Black White are the key choices; recommended to pick all enhanced
2nd | Hua2 | Breach, both damage boosts, are the key choices, unlock nexus
...
Priority | Signet | Details
------ | ------ | ------
1st | Hua2 | Breach, both damage boosts are the key choices, unlock nexus; upgrade breach to max, can also pick +20 stacks from enhanced
1st | Sakura2 | Evasion +1, vulnerability, TDM are the key choices, unlock nexus
...
------ | ------ | ------
1st | Hua2 | Breach, both damage boosts are the key choices, unlock nexus
1st | Aponia2 | 1 3 4 are the key choices; must pick at least breach, recommended to also pick vulnerability
2nd | Kalpas2 | Both damage boosts, vulnerability are the key choices, unlock nexus
2nd | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus
Optional | Griseo1 | Red Yellow Grey are the key choices, don't need nexus; can also pick Kevin both damage boosts as reinforcement
...
Weapon | Stig
------ | ------
Elysian Astra: Heart's Color | Cezanne set
...
##->Ego Signets<-
 River Forest 溪林 | Starry Night 星夜 | Cloud Valley 云谷 | Azure Wind 青风 | Feathers 片羽
:-: | :-: | :-: | :-: | :-: 
**Start** | **Start** | **1st** | Optional | Optional 

##-> Signets<-
Priority | Signet | Details
------ | ------ | ------
1st | Hua2 | Breach, both damage boosts are the key choices, unlock nexus; must upgrade breach to max, can pick 60 stacks
1st | Aponia2 | 1 3 5 are the key choices; recommended to pick all enhanced, must pick at least breach
2nd | Griseo2 | Red Yellow Blue Black Grey are the key choices, recommended to pick all purple, green 
Optional | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus
...
Priority | Signet | Details
------ | ------ | ------
1st | Aponia2 | 3 4 are the key choices, unlock nexus; can pick vulnerability, phys DMG from enhanced
2nd | Griseo2 | Red Yellow Blue Grey are the key choices, recommended to pick all enhanced, prioritise orange
2nd | Pardofelis1 | Both damage boosts are the key choices, unlock nexus
2nd | Kalpas2 | Both damage boosts, vulnerability are the key choices, unlock nexus
Optional | Kosma2 | Ultimate, evasion, basic ATK, time extension are the key choices, unlock nexus
...
2nd | Aponia2 | Basic ATK, SP, vulnerability are the key choices; recommended to pick all enhanced
2nd | Griseo2 | Red Yellow Grey Blue Black are the key choices; recommended to pick all enhanced
Optional | Sakura1 | TDM, vulnerability, are the key choices, don't need nexus
Optional | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus
...
Start | Mad King's Mask/Because of You
1st Shop | Veil of Tears/The Lonely Moon
16F | Ruined Legacy/Tsukimi Himiko
...
------ | ------ | ------
1st | Kalpas2 | Both damage boosts, vulnerability, HP cap up are the key choices, unlock nexus
2nd | Aponia2 | 1 3 5 are the key choices; recommended to pick all enhanced
2nd | Griseo2 | Red Yellow Grey Blue Black are the key choices; recommended to pick all enhanced
2nd | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus 
Optional | Sakura1 | TDM, vulnerability, are the key choices, don't need nexus
...
------ | ------ 
Start | Veil of Tears/The Lonely Moon 
1st Shop | Fragile Friend/The Lonely Moon
16F | Tin Flask/Dreamful Gold 
...
Priority | Signet | Details
------ | ------ | ------
1st | Aponia2 | 1 2 3 are the key choices; recommended to pick all enhanced, prioritise breach, vulnerability
1st | Kosma1 | Basic ATK, ultimate, time extension, SP are the key choices, unlock nexus
2nd | Kalpas2 | Both damage boosts, HP cap up, vulnerability are the key choices, unlock nexus
2nd | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus
2nd | Griseo2 | Red Yellow Grey are the key choices, don't need nexus; can also pick Su vulnerability, both combo boosts as reinforcement
...
Priority | Signet | Details
------ | ------ | ------
1st | Aponia2 | Basic ATK, SP, damage reduction are the key choices; recommended to pick all enhanced, prioritise breach, vulnerability
1st | Kalpas2 | Both damage boosts, HP cap up, vulnerability are the key choices, unlock nexus
2nd | Griseo1 | Red Yellow Grey are the key choices, don't need nexus
2nd | Pardofelis1 | Both damage boosts, HP/SP cap up are the key choices, unlock nexus
2nd | Eden2 | Both damage boosts are the key choices, don't need nexus
...
##->Ego Signets<-
Ill Fortune 厄流 | Ascension 登神 | Dark Assault 袭暗 | Ravenousness 噬界 | Mirage 幽影
:-: | :-: | :-: | :-: | :-: 
...
1st | Hua2 | Breach, both damage boosts are the key choices, unlock nexus; must upgrade breach to max
1st | Griseo2 | Red Yellow Blue Grey are the key choices, can pick White to sustain rotations; recommended to pick purple, green, can also pick orange
2nd | Kalpas2 | Can rely on BR to reduce HP; Both damage boosts are the key choices, don't need nexus
Optional | Sakura1 | TDM, vulnerability, evasion+1 are the key choices, don't need nexus; can also pick Eden starting SP to speed up rotations
...
##->Ego Signets<-
 Ill Fortune 厄流 | Dark Assault 袭暗 | Ascension 登神 |  Ravenousness 噬界 | Mirage 幽影
:-: | :-: | :-: | :-: | :-: 
...
1st | Mobius1 | Both TDMs, vulnerability are the key choices, unlock nexus
1st | Hua2 | Breach, both damage boosts are the key choices, unlock nexus
1st | Griseo2 | Red Yellow Blue Grey are the key choices, can pick White to sustain rotations; recommended to pick all enhanced
2nd | Kalpas2 | Can rely on BR to reduce HP; Both damage boosts are the key choices, don't need nexus
2nd | Sakura1 | TDM, vulnerability, evasion+1 are the key choices, don't need nexus; can also pick Eden starting SP to speed up rotations
...
------ | ------ 
Start | Rainbow of Absence/The Lonely Moon
1st Shop | Forbidden Seed/It Will Be Written
16F | The First Scale/Dreamful Gold

Signet | Choice
------ | :------:
**Blessing of River Forest 溪林** ATK Speed increases during Ultimate | **Start**
**Blessing of Starry Night 星夜** Combo ATK deals extra Physical DMG for every Color Marker consumed | **Start**
**Blessing of Cloud Valley 云谷** Basic ATK SEQ 4 pulls enemies | **1st**
**Blessing of Feathers 片羽** Each bleed stack on enemy increases Total DMG dealt to it. | No
**Blessing of Azure Wind 青风** Triggering Ultimate Evasion grants 3 Color Markers | No


##->Primary Signets<-
Signet | Choice
------ | ------
Griseo2 | Red Yellow Blue Black Grey are the key choices; recommended to pick all enhanced, prioritise orange

##->Secondary Signets<-
Signet | Choice
------ | ------
Mobius1 | Both TDMs, vulnerability are the key choices, can pick support CD; recommended to pick all enhanced, prioritise Dead and Newborn
Su2 | Vulnerability, TDM, both combo boosts are the key choices, unlock nexus
Pardofelis1 | Both damage boosts are the key choices, unlock nexus
Sakura1 | TDM, vulnerability are the key choices, don't need nexus; can also pick Kalpas as reinforcement
...
------ | ------
Domain of Sentience | Dirac TM + Onyx Simurgh B
High atk weapon | Shattered Swords set
...
------ | ------ 
Start | Veil of Tears/The Lonely Moon 
1st Shop | Mad King's Mask/It Will Be Written
16F | Ruined Legacy/Dreamful Gold

Signet | Choice
------ | :------:
**Blessing of Victory 席胜** Increase number of consecutive combo ATKs in Herrscher Form  | **Start**
**Blessing of Dark Plumes 黑羽** Combo attack triggers feathers that apply vulnerability and restore SP  | **1st**
**Blessing of Supremacy 独尊** Refreshing or ending shield deals AOE physical dmg | Reinforcement
**Blessing of Legion 百兵** After using Combo ATK, restore energy and gain Total DMG | Reinforcement
**Blessing of Ego 本我** Using Combo ATK summons illusion that copies your attacks  | No

##->Primary Signets<-
Signet | Choice
------ | ------
Aponia2 | 3rd and 4th are the key choices, unlock nexus, can pick vulnerability from enhanced.
Kalpas2 | Both damage boosts and vulnerability are the key choices, unlock nexus

##->Secondary Signets<-
Signet | Choice
------ | ------
Griseo2 | Red Yellow Blue Grey are the key choices, must pick all enhanced, prioritise orange
...
16F | Stained Sakura/Boundless Logos

Signet | Choice
------ | :------:
**Blessing of Innateness 内能** Restore SP and reduce CD when summoning Space Core | **Start**
**Blessing of Coleus 空棘** Physical DMG dealt by Space Core increases | 2nd
**Blessing of Annihilation 蔑尽** In Herrscher Form, the 3rd SEQ of Basic ATK includes a Charged ATK.  | Reinforcement
**Blessing of Virtuality 虚界** Ultimate Evasion Skill can be triggered unconditionally | Reinforcement
**Blessing of Law 律今** Aerial explosion triggered after Ultimate deals Physical DMG. | No

##->Primary Signets<-
Signet | Choice
------ | ------
Vill-V2 | 1,2,3 are the key choices, recommended to pick all enhanced, prioritise breach and vulnerability
Sakura1 | Vulnerability and evasion+1 are the key choices, followed by evasion+1, unlock nexus
Hua2 | Breach and both damage boosts are the key choices, unlock nexus

##->Secondary Signets<-
Signet | Choice
------ | ------
Griseo1 | Red Black are the key choices, don't need nexus; can buy in shop
Mobius1 | Both TDMs and vulnerability are the key choices, unlock nexus, can pick Dead[X]; can buy Su, Kalpas, and Eden signets in shop as reinforcement
...
#->Sixth Serenade<-
->![6s](https://i.imgur.com/7b82bo3.png)<-
...
##->Ego Signets<-
 Nocturnal Tides 夜潮 | Tragedy 悲幕 | Finale 终曲 | Raven Eye 鸦眸 | Expiation 寻罪
:-: | :-: | :-: | :-: | :-: 
**Start** | **Start** | **1st** | Optional | Optional 
...
Priority | Signet | Details
------ | ------ | ------
1st | Aponia2 | Basic ATK, SP, vulnerability are the key choices; recommended to pick breach and vulnerability from enhanced
2nd | Sakura2 | Vulnerability, TDM, evasion+1 are the key choices, unlock nexus
2nd | Griseo2 | Red Yellow Blue Black Grey are the key choices, recommended to pick all enhanced
...
->![tp](https://i.imgur.com/TAeB2sy.png)<-
...
#->Sweet 'n' Spicy(Abstinence)<-
->![carole](https://i.imgur.com/LGSHHWh.png)<-

##->Recommended Gear<-
Weapon | Stig
------ | ------
Oblivion Down | Bianka: Theatre set
...
16F | Proof of Good and Evil/Hometown

Signet | Choice
------ | :------:
**Blessing of Revolution 轰旋** Each charging stage reduces Ultimate CD.  | **Start**
**Blessing of Skyfall 擎落** Each stage of aerial charging stacks Momentum up to 6.  | No
**Blessing of Impulse 冲决** Armor Shredder maxes at 6 stacks and stacks twice each time.  | No
**Blessing of Brake 制动** Charging speed accelerates  | No
**Blessing of Rupture 裂岩** Ground Charged ATK can charge up to 4 stages.  | No

##->Transition Signets<-
Signet | Choice
------ | ------
Griseo1 | Start with Yellow, buy Red and Black from shop, don't need nexus 

##->Primary Signets<-
Signet | Choice
------ | ------
Aponia2 | 4th is the key choice. Can pick all enhanced, prioritise breach.
Pardofelis1 | Both silver boosting signets are the key choices, prioritise enhanced breach and Ultimate.

##->Secondary Signets<-
Signet | Choice
------ | ------
Sakura2 | Vulnerability and TDM are the key choices, unlock nexus
Kalpas1 | Both damage boosts and vulnerability are the key choices, don't need nexus