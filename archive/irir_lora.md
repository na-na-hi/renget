...
個人的に感じる変化をピックアップ。
- 細部の描画力が大幅に向上
	文字とかヘイローが崩れにくい。目の描画が明らかに良い。ドロドロに溶けていた瞳孔が改善。SD1.5のhighres.fixにあった霞んだような質感がない。
- 語彙力が大幅に向上
	LoRAなしで出せるキャラが増えた。
- 破綻が減少
...
![Image](https://files.catbox.moe/q1oqcm.webp)
unetのみでは背景が勝手に灰色になったり川になったりする。色も若干おかしい。

#### まとめ
unetオンリーでは背景が不自然になり、色もおかしくなり、プロンプトを無視されやすくなる。
したがって、画風の学習でもText Encoder込みで学習したほうが良い。TEのLRはunetの10分の1未満で良いかも？

### モデルにマージする
TE込みで回したLoRAをベースモデルにマージしたモデルのTEをSupermergerで元のモデルに差し替えてみた。
...
#### 収束にかかるステップ数
LR=0.0001,Optimizer=Lion,Dim=16,Alpha=4

![Image](https://files.catbox.moe/96e0xc.webp)
1000ステップで十分じゃね？でも2000ステップが怪しい。

![Image](https://files.catbox.moe/epzy8j.webp)
1000ステップでもかなり再現した。2000か3000ステップがいい感じ

![Image](https://files.catbox.moe/19u0ko.webp)
教師画像が少ないせいなのかやや不安定。2000ステップ以上で再現できる。

![Image](https://files.catbox.moe/w7wtna.webp)
1000ステップはダメだが2000以上は良い。服を間違えるのはSDXLとdanbooruタグの限界。

2、4キャラ同時学習にもかかわらず、1000ステップでそれなりに再現できている。
想像より収束が早いようだ。2000-3000ステップで十分。
...
#### まとめ
精度改善は微妙だが、変色などが無くなり学習の安定性が向上した。しかし、コントラストが上がってしまった(魔人3.1の癖？)。まあLBWでどうにかなると思う。
...
![Image](https://files.catbox.moe/xai7kp.webp)
青がLR=1で赤がLR=0.5
