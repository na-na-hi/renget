...
## 概要
[原神LoRA検証](https://rentry.co/genshin_lora)に書き足すのは限界があるので、原神キャラ再現以外を記録する。というかあっちはもう更新しないと思う。
参考程度に。

## 注意
NSFW画像があるので閲覧注意。
このメモはあくまでも一例です。このメモだけで結論を出すのは間違いです。他者の記事や検証も参考にしてください。
...
![Generated by AI](https://thumbs4.imagebam.com/99/5f/14/MEKAYAB_t.png) | <lora:arona_lowdim:1>1girl, arona \(blue archive\), school uniform, serafuku, upper body | 単純なキャラデザなのでdimを32にしてみる。 再現度が低下した。キャラ再現でDim32はさすがに無理だった。
...
Image | Prompt | Description
 ------ | ------ | ------
![Generated by AI](https://thumbs4.imagebam.com/37/01/25/MEKAYON_t.png) | <lora:nendoroid_v1.1:1>1girl, nendoroid | いけるやん
![Generated by AI](https://thumbs4.imagebam.com/17/ad/cd/MEKAYOO_t.png) | <lora:nendoroid_v1.1:1>1girl, nendoroid, red hair, bangs, kimono, forest | いけるやん(背景は変化しないが)
![Generated by AI](https://thumbs4.imagebam.com/bc/5a/b4/MEKAYOS_t.png) | <lora:nendoroid_v1.1:1><lora:hifumi:1>1girl, nendoroid, hifumi \(blue archive\), serafuku | キャラLoRAと併用。問題なし。
...
生成解像度 | Prompt | Image | Description
 ------ | ------ | ------ | ------
512x512 | <lora:shiroko_512:1>1girl, shiroko \(blue archive\), school uniform, id card, gloves, blue necktie | ![Generated by AI](https://thumbs4.imagebam.com/ae/ac/7b/MEKAYOT_t.jpg)https://www.imagebam.com/view/MEKAYOT | よくなったよね？
768x768  | 〃 | ![Generated by AI](https://thumbs4.imagebam.com/3e/47/3c/MEKAYOV_t.jpg)https://www.imagebam.com/view/MEKAYOV | 
1024x1024 | 〃 | ![Generated by AI](https://thumbs4.imagebam.com/e0/13/4d/MEKAYOX_t.jpg)https://www.imagebam.com/view/MEKAYOX | 
512x768 | <lora:shiroko_512:1>1girl, shiroko \(blue archive\), school uniform, id card, gloves, blue necktie, cityscape, looking at viewer | ![Generated by AI](https://thumbs4.imagebam.com/e9/84/dd/MEKAYP1_t.jpg)https://www.imagebam.com/view/MEKAYP1 | 512でもたまに出る
↑のHighes.fix(2倍) | 〃 | ![Generated by AI](https://thumbs4.imagebam.com/c0/f1/e3/MEKAYP3_t.jpg)https://www.imagebam.com/view/MEKAYP3 | 1024が最も再現度が高い
512x768 | <lora:shiroko_512:1>1girl, shiroko \(blue archive\), school uniform, (id card:1.1), gloves, blue necktie, city | ![Generated by AI](https://thumbs4.imagebam.com/52/ac/68/MEKAYP7_t.jpg)https://www.imagebam.com/view/MEKAYP7 | 1024は安定して三角形が出る。ABYDOSの文字と太陽までは出ない

1024はid cardのアビドスの模様が最も正確に出ている。
768でもある程度再現できた。512はほとんど溶けてしまった。
#### まとめ
1024pxで精細な模様の再現性が向上する可能性がある。
...
#### 例
![IMG](https://thumbs4.imagebam.com/38/a0/7a/MEKAZSO_t.png)
上の画像には次のタグがつけられた。
...
## 大体成功する設定(キャラ)
教師画像枚数:64以上。繰り返し数は1epochが512steps前後になるように調整
Epoch数:総step数がbatch1相当で4096前後になるように調整
解像度:512
Optimizer:AdamWまたはDAdaptLion
LR:0.0001(DAdaptLionなら1)
正則化:無し
...
dim64,alpha16
conv_dim,conv_alphaはdim,alphaと同じ値を設定
以下任意:
cache latent: True
color aug: False