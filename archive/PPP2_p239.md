> https://rentry.org/PPP2_p239
```cpp
// Code derived from Stroustrup's PPP2 book
// § 7.7 Recovering from errors
//  -and beginning on p 239
...
```
>*build & run:*
`g++ -std=c++20 -O2 -Wall -pedantic ./ch_07/main_p239.cpp && ./a.out`
!!! info *sauce:*
    [Bjarne Stroustrup's PPP2 textbook](https://www.stroustrup.com/programming.html) 
    [/robowaifu/'s official C++ learning textbook thread](https://alogs.space/robowaifu/res/18749.html#18749)
[Prev](https://rentry.org/PPP2_p237) • [Up](https://rentry.org/PPP2_ch07) • [Next](https://rentry.org/PPP2_p240)