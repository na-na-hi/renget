...
####How do I download these "models"?
Using the very quick chart above: pick your poison and then download the following torrent to find the model you're looking for.
...
These are the quantized 4bit HuggingFace models. If you're looking for another model, visit [this rentry guide for more models.](https://rentry.co/nur779)

####Okay, so where should I begin?
You should start by setting up oobaboogas text-generation-webui. Doing this will set up a lot of dependencies other programs use, and oobabooga is a good gateway to getting started with text generation and LLM. Once you've done this, you can move on to setting up more models, KoboldAI, TavernAI and Pygmalion if you wish to.
**But if your computer isn't beefy enough to run the bigger models, go ahead with llama.cpp.**
...
As I said, I wont be detailing how to make prompts/bots because theres a lot that goes into it that I can't simplify for this guide. But what you CAN do is browse and download prompts to test for yourself. The most popular starter ones is the Miku one, which you can find [here.](https://pastebin.com/vWKhETWS) Theres also a good one called RPBT (RolePlayBoT) which is, as said, good for roleplaying. You can find it [here.](https://rentry.org/RPBT)
As for other prompts, well, I can't help you. Search around the internet and surf for some cool character prompts you'd like, and learn how to write your own. That's about the best way to have a good prompt.
