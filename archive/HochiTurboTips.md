...
***
!!! info nuTurbo prompts status: plapped and done.
	We've done all we could here. People say they work on GPT-4 too, give them a try.
!!! note Attention!
...
Now, this is not too shabby, and it will give you decent results. I'm still not writing this format off, and I'll use it in some of my future bots. However, there are nuances.
...
- Turbo tends to often cling to the list items verbatim. One of my private chars has "piercing blue eyes" as part of the list, and I swear I see them in every other output. Claude and GPT-4 don't do it as often, but they occasionally still do.
...
11.7.2023 - expanded "Botmaking" section with some additional info; added some notes about negative Freq and Pres penalties.
