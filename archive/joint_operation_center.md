...
!!! info
     -> ![](https://files.catbox.moe/f9inkg.png)  **Addendums**  ![](https://files.catbox.moe/f9inkg.png) <-

##### ![](https://files.catbox.moe/f9inkg.png) [Nerissa's Merchandise](https://rentry.org/nerissa_ravencroft_merch01)
A list of all the merchandise that Nerissa has released, both physical and digital goods.

##### ![](https://files.catbox.moe/f9inkg.png) [Nerissa sounds](https://rentry.org/demon_of_soundposts)
