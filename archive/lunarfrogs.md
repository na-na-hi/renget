...
Yep, these settings only hide the codeblock from your view, the text inside is actually kept and sent as Context if you continue the conversation or export your chat to agnai/venus.
