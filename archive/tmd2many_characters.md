...
->Everything here is what you'll need to find other sheets about characters and what you need to know to make your own! Please ask to have your character sheet added to the list.<-
->*If anything looks familiar, I promise I didn't copy any homework. Maybe.*<-

->![Do you remember anything, human?](https://cdn.imgchest.com/files/w7pjc6v9l7p.png)<-
->**[BACK TO RULESET](https://rentry.co/tmd2many_rules)**<-
***
!!! info Table of contents below:
[TOC2]
***
!!! warning Character Sheet Links: tmd2character_(insertname)
...
You can find an explanation on [Origins](https://rentry.co/tmd2many_words#origins) here.
...
[Mohka](https://rentry.org/tmd2character_mohka)  | Ex-Human (Fragmented) | Kommo-o | N/A | N/A
...
Below is how a Character Sheet may look like, so it may give you an idea how to correctly fill out the blank spaces in the Template Sheet.
...
### Sparks ♂
Sparks was found by the guild when he showed up one day. Unable to remember a single thing about the life before him, he's decided to dedicate this new life to adventuring. While having the tendency to easily become lost without directions, he's elected to learn how to use the Wonder Maps to guide his way when delving deep into the dungeons. He's made great friends with the other members of Team Shock... and they're always first into battle!

· | ->· ->
---- | ----
**Origin:** Ex-Human (Amnesia) | **Guild Role:** Cartographer
**Species:** Pikachu | **Affiliation:** Team Shock
**Level:** 56 | **Experience to Next Level:** 223/1350
**Worn Item:** Sneak Scarf | **Clothing:** *N/A*
**Pokécoin:** 551₽ | **Glorious Gold:** 3 Bars
...
->Silver Rank<-
->*22/4000 points to Gold Rank*<-
->![Silver Rank](https://archives.bulbagarden.net/media/upload/5/57/Silver_Rank_RTDX.png)<-

Stat  | Points: 14 (+1) | Modifiers | Combat Effect
------ | :----: | :----: | :----: 
Health Points | 1 | Level 56 (36HP) | 38HP
Attack | 3 | Level Damage Bonus **ɪɪ** | +5 Physical Damage 
Special Attack | 3 | Level Damage Bonus **ɪɪ** | +5 Special Damage
...
--- | -- | - | - | - | - | ---------
Electro Ball | 10BP | 7AP | ≥2 | Electric | Special | The Move's BP is decreased by the Opponent's AP.
Quick Attack | 4BP | 5 (-1) AP | ≥2 | Normal | Physical | Priority. AP cost decreased by 1.
Thunderbolt | 9BP | 7AP | ≥2 | Electric | Special | 19-20; The Opponent is afflicted with *Paralysis.*
Iron Tail | 10BP | 6AP | ≥6 | Steel | Physical | Priority. 14-20; The Opponent's Defense is decreased by 1.
Basic Attack | 4BP | 4AP | ≥2 | Typeless | Special | Property determined by the User's highest Offensive Stat. Changes Type according to the use of a Type Gem. The simplest Move a Pokémon can use.
...
------ | :----: 
*Worn/Held Item: Sneak Scarf* | The user becomes almost like a Ghost-Type, harnessing the power of sneak. (+5 Sneaking Skill).
*Equipped Item: N/A* | Vacant hand slot.
1. Reviver Seed | Revives fainted Pokémon to full HP.
2. Reviver Seed | Revives fainted Pokémon to full HP.
3. Oran Berry | Heals the user for 10HP.
4. Pecha Berry | Cures the user. Heals Poison.
...
->![Bronze Rank](https://archives.bulbagarden.net/media/upload/8/81/Bronze_Rank_RTDX.png)<-
```
->Bronze Rank<-
->*0/2000 points to Silver Rank*<-
->![Bronze Rank](https://archives.bulbagarden.net/media/upload/8/81/Bronze_Rank_RTDX.png)<-
...
->![Platinum Rank](https://archives.bulbagarden.net/media/upload/e/e0/Platinum_Rank_RTDX.png)<-
```
->Platinum Rank<-
->*0/7000 points to Diamond Rank*<-
->![Platinum Rank](https://archives.bulbagarden.net/media/upload/e/e0/Platinum_Rank_RTDX.png)<-
...
->![Diamond Rank](https://archives.bulbagarden.net/media/upload/f/fb/Diamond_Rank_RTDX.png)<-
```
->Diamond Rank<-
->*0/9000 points to Ace Rank*<-
->![Diamond Rank](https://archives.bulbagarden.net/media/upload/f/fb/Diamond_Rank_RTDX.png)<-
...
->![Ace Rank](https://archives.bulbagarden.net/media/upload/2/26/Hyper_Rank_RTDX.png)<-
```
->Ace Rank<-
->*0/12000 points to Master Rank*<-
->![Ace Rank](https://archives.bulbagarden.net/media/upload/2/26/Hyper_Rank_RTDX.png)<-
...
->![Master Rank](https://archives.bulbagarden.net/media/upload/9/95/Master_Rank_RTDX.png)<-
```
->Master Rank<-
->*0/25000 points to Grand Master Rank*<-
->![Master Rank](https://archives.bulbagarden.net/media/upload/9/95/Master_Rank_RTDX.png)<-
...
->Grand Master Rank<-
->***MAX** Rank Achieved!*<-
->![Grand Master Rank](https://archives.bulbagarden.net/media/upload/a/a3/Grand_Master_Rank_RTDX.png)<-
```
->Grand Master Rank<-
->***MAX** Rank Achieved!*<-
->![Grand Master Rank](https://archives.bulbagarden.net/media/upload/a/a3/Grand_Master_Rank_RTDX.png)<-
