...
!!! info Upcoming changes:
	There is an upcoming Pico 4 firmware (Version 5.9.0) as well as a new version of the Pico Streaming Assistant (Version 10.0.0, which is being renamed to Pico Connect) which proposes new architecture and better compatibility. It is possible these things may improve encoding quality with Pico Streaming Assistant as well as the microphone latency issue, but I am not holding my breath.
