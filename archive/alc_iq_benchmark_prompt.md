...
```json
    {"id":"x0_notlike_crowds",        "expected": 5.0, "replacements": [["<STATEMENT>", "I don't like to be in places with many people."]]},
    {"id":"x1a_like_quietplaces",     "expected": 5.0, "replacements": [["<STATEMENT>", "I prefer quiet places."]]},
    {"id":"x1b_notlike_noisyplace",   "expected": 1.0, "replacements": [["<STATEMENT>", "I like to be in noisy places with many people."]]},
    {"id":"x2_like_minerals",         "expected": 5.0, "replacements": [["<STATEMENT>", "I like to collect minerals"]]},
    {"id":"x3_dont_minerals",         "expected": 1.0, "replacements": [["<STATEMENT>", "I do not collect mineral rocks"]]},
    {"id":"x4_ppl_person",            "expected": 1.0, "replacements": [["<STATEMENT>", "I am a people person."]]},
    {"id":"x5_shy",                   "expected": 5.0, "replacements": [["<STATEMENT>", "I am shy."]]},
    {"id":"x6_star_trek",             "expected": 5.0, "replacements": [["<STATEMENT>", "I like to watch Star Trek."]]},
    {"id":"x7_details",               "expected": 5.0, "replacements": [["<STATEMENT>", "I see details that other people often miss."]]},
```
...
Just as reference, the order of the sampling algorithms in llama.cpp (or prompt_runner) are:
