...
There are other cloud hosts you can use with Kobold Lite. That includes everything under "Custom AI Endpoint". You can [pay](https://openai.com/) for [them](https://claude.ai) or get them for [free](https://rentry.org/desudeliveryservice). Or you can do [both](https://rentry.org/proxy4sale).
