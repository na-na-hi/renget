...
Step 1: Download the **NEW** 1.4 model from [**HERE**](https://drive.yerf.org/wl/?id=EBfTrmcCCUAGaQBXVIj5lJmEhjoP1tgl)
...
[**mirror**](https://api.ipfsbrowser.com/ipfs/get.php?hash=QmRZhhXupwfdseS6PJT31ZFXegGeLT2LwMLZkcjnhi8Efu)
...
**--NOTES AND TIPS--**
- Build great prompts using the [prompt builder](https://promptomania.com/stable-diffusion-prompt-builder/)
