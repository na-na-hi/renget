...
I also made a bunch of FFT inspired AnimateDiff clips here. https://mega.nz/folder/1FZHDTAQ#RGGfgDgXb2i2LYieaOuSbA
...
You can weigh this above 1.0 and in general it's pretty overpowering compared to the other loras below, but it's great.
...
I think someone on Twitter shared this with me, it emulates the old school TO style. Great if you want the retro look but you might want to lower the strength.
...
I usually have this enabled at very low strength regardless of what I'm doing. Even 0.1 is good enough to add some of that nostalgic styling that will fight against the modern styles your model and the Akihiko Yoshida Lora will supply. Setting the strength high will create some very unusual and abstract images in modern models.
...
Another FFT portrait LoRA, this one is newer and works better than the one above.
