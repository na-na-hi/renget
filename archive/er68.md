...
SIGNET 1
In Soul Crafting Form, when Joint Combo hits an enemy, deal additional ~~800%~~ **250%** ATK Physical DMG. When combo hit reaches a multiple of 50, enemies take ~~25%~~ **15%** more Total DMG for 8s, can be refreshed. In Life Ending Form, Joint Combo final hit deal additional ~~2000%~~ **1600%** ATK Physical DMG.

SIGNET 2
In Life Ending Form, ~~Joint ATK Physical DMG +90%~~ **Joint Weapon pulls enemies and each hit deal additional 50% ATK Physical DMG**, gain extra 20 Herrscher energy when Joint Weapon hits an enemy (CD: 0.5s). When Joint Combo hits an enemy, weapon cd ~~-10s~~ **-15s** (trigger cd: 1s) and gain 900 hp.

SIGNET 3
In Life Ending Form, ~~Combo ATK and Joint Combo Total DMG +35%~~ **Combo ATK and Joint Combo deal additional 150% ATK Physical DMG** , and the enemies hit take ~~25%~~ **10%**  more Total DMG for ~~5s~~ **8s**. Non ultimate evasion will also trigger evasion skill.

SIGNET 4
In Soul Crafting Form, ~~Physical DMG +70%.~~ Hold ATK button to continuously fire Basic ATK SEQ 4 shots, deal additional ~~50%~~ **120%** ATK Physical DMG per hit. **Final hit of Joint Combo deal additional 400% ATK Physical DMG**

SIGNET 5
In Soul Crafting Form, if sp > 40, Joint Combo consume 40 sp to gain Total DMG +45%. Basic ATK final hit restore 900 HP and give 50 extra combo, recover 50 sp and briefly pulls enemies (CD: 1s)