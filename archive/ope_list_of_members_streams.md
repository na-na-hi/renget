!!!note -> ![Image description](https://files.catbox.moe/f9inkg.png)  **Jailbirds House**  ![Image description](https://files.catbox.moe/f9inkg.png) <-
	...
	Another word of warning: we're not planning to store nor making a list of any posts from the members section - that would be unfair for anyone that spent the minimum threshold for supporting Nerissa and it's not highly regarded either.

!!!info -> *Disclamer regarding member zatsus or zatsudan parts*  <-
    This list exists mainly provide a brief overview over Nerissa's members streams. Due to the sensible nature of the Zatsudan bits ,which will inevitably happen in the case of the members streams (even in non-specified Zatsudan streams) and will contain topics that might be too personal or more personal, the list cannot be a replacement for members content nor is it meant to be a replacement. Which is why in that case, the description might be a little vague and a full overview for these streams will not be provided. There's also a chance these topics might also end-up in non-members content.
