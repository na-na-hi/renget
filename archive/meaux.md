...
==About "raise entropy randomly between a seed range of 0 and 1000, absent from outputting it" -- Since some niggers OBSESS with so little... This has NOTHING to do with an inbuilt function or capability of a fucking LLM. The phrasing I picked was to minimize it outputting the fucking counter and avoid getting hit by the filter, as well as keep it human friendly, as in "oh, this is the counter". "hurr durr but it doesn't make it more random", fuck with Top K and Top P, there you have a VERY predictable bot and RP; I kept this line from a 10/10 freedom JB that had tinkered Tops, and the only way to avoid the same or almost the same responses was by making it shuffle something IN CONTEXT, just for the sake of it. You can remove it if that helps you sleep at night.==
