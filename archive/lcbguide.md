...
If you want to get the most out of your Egoshards, you can either focus on Identities and E.G.O in the tier list, ones marked as Event/current Season, preferably both if it applies.

As for when to shard, it is best to wait right before the Season ends in case you get spooked when rolling. But if you really want something now, whether it be for the Railway or something else, you can do it whenever if you have the Egoshard Crates to justify it.
