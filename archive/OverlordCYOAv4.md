...
It is generally wise to have at least 10 in each Attribute,
With a higher Value going towards build-specific Attributes
 
Having not maxed an Attribute at 40 is also wise as it allows
Attribute buffs to not be wasted
 
Spellcasters only need 20 in their casting Attribute to cast 10th-tier spells
provided they have enough mana and high enough caster level to qualify
 
Attributes also determine your Skill potential,
keep that in mind
...
Spiritual Magic - The Tradition of the Spirit.
Can Manifest Spells containing Elemental or Negative Energy
Can Summon Elemental, Ghost, and Spirit NPCs
...
Dwarf [ML +5/V +1] [H 50%/C -25%/D -25%]
  Can choose a Pure-Blood Dwarf type: Deep, Hill, or Mountain:
    ...
    Mountain Dwarves are 50% harder to Knock Out or Stagger
...
Goblinkin [ML +15/V +18] [H 25%/A -25%]
  Can choose between Goblin, Orc, Troll, or Bugbear:
    ...
    Bugbears are 50% harder to Knock Out or Stagger
...
Giantkin [ML +15/V +26] [H -25%/C 50%/A -25%]
  Can choose Cave, Frost, Mountain, or Sea varieties:
    ...
    Mountain Giants are 50% harder to Knock Out or Stagger
...
Angel [ML +5/CL +20/V +21] [A 25%/S -25%/L 75%/D -75%]
 {Can choose to be a Fallen Angel, reversing Light and Dark Resistances and Karma Abilities}
  ...
  Choose one Domain, and assign a Arcane Specialization to which it roughly corresponds to.
    You can access Classes with those Specialization requirements.
  You cast spells from your Domain at halved Mana Cost
 
Demon [ML +15/CL +10/V +27] [C -25%/S 25%/L -75%/D 75%]
...
Slime [ML +15/CL +10/V +24] [H -50%/C -50%/A 50%/E 50%]
  ...
  Are 50% harder to Grapple, Knock Out, or Stagger
...
Bright Lord (Req. Non-Fallen Angel or Redeemed Demon, Costs 10 Levels) [CL +10/V +8]
  ...
  Radiant Lord (Req. Bright Lord, Costs 5 Levels) [CL +5/V +3]
    Gain +25% Resistance (Immunity) to Light Elemental damage, but gain -25% weakness to Dark
...
Dark Lord (Req. Fallen Angel or Non-Redeemed Demon, Cost 10 Levels) [CL +10/V +8]
  ...
  Shadow Lord (Req. Dark Lord, Costs 5 Levels) [CL +5/V +3]
    Gain +25% Resistance (Immunity) to Dark Elemental damage, but gain -25% weakness to Light
...
Puffball (Costs 10 Levels) [CL +10/V +8]
  ...
  Stinkball (Req. Puffball, Costs 5 Levels) [CL +5/V +3]
    ...
    AoE attacks can cause Poison DoTs and Disease DoTs, and last much longer
...
Bolete (Costs 10 Levels) [ML +10/V +18]
  ...
  King Boletus (Req. Bolete, Costs 5 Level) [ML +5/V +5]
    ...
    Are harder to Knock Out or Stagger
...
Pixie (Costs 10 Levels) [CL +10/V +6]
  ...
  Sylph (Req. Sprite or Pixie, Costs 5 Levels) [ML +5/V +4 OR CL +5/V +3]
    Can Fly 50% faster and are 50% harder to hit while moving during flight
...
Hex Maniac (Requires Int 11+ or CHA 11+, Knowledge (Arcana) 15+) [CL +15/V +12]
  Have Spiritual Spellcasting (INT or CHA)
  Can detect and identify all supernatural buffs and debuffs on a target by taking a supernatural action
  Can channel mana into spells that inflict negative status effects to increase the duration, damage, effect, or number of Targets, among other options
 Can summon a powerful ghost companion, once every 72 hours

Psychic (Requires WIS 11+ and CHA 11+) [CL +15/V +12]
  Have Spiritual Spellcasting (WIS or CHA)
  Can Identify Supernatural Actions a Target is attempting
  Can communicate and /or detect any nearby beings telepathically by using a supernatural action
  -This communication transcends language barriers, and can be exclusive to certain targets if the Psychic wishes
  Are aware of attempts to inflict Mental Status Effects, and are Immune to Mental Status Effects
...
Talismancer (Requires CON 11+ and INT 12+, and Craft (Calligraphy) 15+) [ML +10/CL +10/V +13]
  Know how to use Ranged Weaponry (Notably Talismans)
  Have Weak Spiritual Spellcasting (INT or CON)
  Can create and use cards called ‘Talismans’, in half the time and using less materials than normal
  These function similarly to Scrolls, but can be activated by throwing at a target or location in addition to being read by the user; abilities that interact with Scrolls usually interact with Talismans as well
  Targets physically struck or touched with Talismans when they activate suffer reduced resistances to the Talisman’s effects

Onmyoji (Requires INT 11+ and Knowledge (Religion) 15+) [ML +0/CL +15/V +12]
  Have Spiritual Spellcasting (INT)
  Choose at least two elemental focuses form the following list: Light, Dark, Earth, Fire, Metal, Water, Wood or Void 
  -You cast spells associated with your elemental focus at reduced mana cost (two focus = 1/4 reduction, four 1/16 etc)
  Can create a custom spell that is from at least two of your chosen Elemental Focuses. Can only be used once every 24 hours. 
  Can summon a powerful Shikigami NPC, that is associated with one of your focuses, once every 72 hours.
...
Perform an attack Action means that you can attack in any way that you normally would to apply the effect of the ability,
but some Weapon types will restrict which attack Actions can apply the Effect. For example, while wielding a Spear you
can only apply a Sunder Effect with a Thrust attack, but while wielding an Axe you can apply it with a slash attack.
No mention of a duration means it has a short cooldown.
 
Perform an Action (magic) means that you can recite a chant or mantra, make a gesture or series of gestures with your hands or
limbs, or utilize a casting focus. There are certain other actions that can qualify, but these are odd exceptions. They cost no mana.
...
Sky Dancer (Req. Wings/Supernatural Flight and Flight 30+) [ML +10/V +16 OR CL +10/V +8]
  ...
  Maximum flight speed is increased by 50%
...
Grenadier (Req. Notable at throwing weapons) [ML +10/V +14]
  Can create basic explosives that deal Physical Damage and cause Burn, Bleed, Blind, 
    Explosives are consumable items, and don't take up an item slot
  Can throw Objects farther and have greatly increased accuracy when throwing Objects
  AoE attacks have a increased chance to cause secondary effects, and have a increased radius
...
Geisha (Requires Bard, Craft (Calligraphy) 25+ and Knowledge (Nobility) 25+) [CL +10/V +8]
  Spell Mana cost is no longer doubled, and can choose to change to Spiritual Spellcasting (CHA),
    remain having Nature Spellcasting (CHA), or have both
  Can perform a lengthy ceremony to boost the resistances of targeted allies for an extended duration, 1/day
  Receive a bonus to all non-combat interactions with NPCs
...
Contemplative (Req. Divine Spellcasting) [CL +10/V +8]
  Choose one Domain. Cast spells from your Domain at halved Mana cost.
    Assign a Specialization which your Domain roughly corresponds to. You can access Classes with those Specialization reqs.
...
Polytheist (Req. Divine Spellcasting) [CL +10/V +8]
  Choose two to twelve Domains.
    For each Domain, you can access Classes with roughly corresponding Specialization requirements.
...
Illusionist (Req. Illusion Specialization or Fey Race) [CL +10/V +8]
...
Death Mage (Req. Undead, or Evocation/Necromancy Specialization) [CL +10/V +8]
  ...
  Are Immune to Instant Death and Doom
...
Soulknife (Req. Martial Weaponry or Lethal Unarmed strikes) [ML +10/CL +5/ V +14]
  Gain Weak Spiritual Spellcasting (WIS)
  Can create and use a ‘Mind Blade’ natural weapon; this weapon counts as magical
  Can channel Mana while attacking with the Mind Blade to inflict additional effects
 
Astrologer (Req. Divine or Spiritual casting) [CL +10/V +8]
  Give a target’s fortune, once per month per person, giving them a small luck bonus or penalty for the rest of the month
  When outdoors at night, can perfectly determine direction to a specified target object, location or character
  Can create a custom spell, based on the Astrologer’s birth sign (the character’s, not necessarily the player’s). This spell can be used once every 24 hours, or 3/day during the user’s birth month

Talisman Shooter (Req. Talismancer) [ML +5/CL +10/V +14]
  Weak Spiritual Casting becomes Spiritual Casting (INT or CON)
  Increased attack speed when attacking with Talismans
  Have a chance to attack twice with each talisman per attack
...
Blight Mage (Req. any Spellcasting and CON 14+) [CL +10/V +10]
...
Healer (Req. any Spellcasting and INT or WIS 13+) [CL +10/V +10]
  Healing Spells you cast are much harder to Negate or Dispel, and effects that drain your mana are half as effective
  Can Perform a lengthy cast time to cast a Healing Spell at halved Mana cost
  Can channel Mana to restore Vitality to a Target, efficiency scales with Level
 
Somatomancer (Req. Regeneration and CHA 14+) [ML +5/CL +10/V +10]
  Can control your limbs remotely
  Can launch your limbs at enemies to attack, launched limbs can use touch abilities
  Can Perform an attack Action using a launched limb to deal damage through a Target's back
...
Runesmith (Req. Dwarf and Smithing 30+, Costs 10 Levels) [ML +10/V +12 OR CL +10/V + 12]
  Can imbue Crafted Objects with a Rune to create a permanent Magic item
    Runes work differently from data crystals, refer to the end of the data crystal section
  Can double the effectiveness of one effect imbued into a Consumable, Weapon, or Crafted Object, once every 8 hours
  Can identify any Spells imbued into a Consumable, Weapon, or Crafted Object

Additional job classes and QnA:
https://rentry.org/OverlordCYOAStuffv4
...
Grand Grappler (Req. Arthropod, Slime or Planterran, and Wrestler, Costs 5 Levels) [ML +5/V +9]
  Can Perform other Physical Actions at no penalty while Grappling a Target
  It is harder for a Grappled Target to escape once Grappled
...
Even if the Servers were announced to be shut down, it didn't prevent the devs putting one last gacha banner
World-Class Gacha, absurdly good rates, but for a game on it's last leg, a way to cash out on whales
To those who rolled even once, receive one Exceedingly Rare Special Item Ticket. This ticket can be exchanged for one 1% item.
...
[Banned] (Req. Possessing 2 World-Class Items) (Must be taken if you meet the requirements)
  Due to unexpected high rate of World Class Items, the Yggdrasil automated system has been suspending
    accounts on the grounds of cheating. Due to the game closing, the devs can't or won't help get users 
    their accounts back. Best to give it to an NPC, trade it away or let it all end one day earlier.
! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! !
________________________________________________________________________
________________________________________________________________________
    ...
    *[Energy Vulnerability (4)] - Weapons attacks ignore 50% chosen Energy Resistance
    ...
    [Fell the Greatest Foe (5)] - Deal extra damage the targets for every 'Strength is considered 2x higher' ability they possess.
       ...
       [Greater Spellcrash (9)] - Target loses 12 Mana per hit
         ...
         [Vanishing Weapon (6)] - Summoned Creatures get Banished when struck with weapon
...
________________________________________________________________________
Natural Weapon Gear Data Crystals:
...
[Blitzstrahl (5)] - Attacks are imbued with Electric Energy type and are likely to cause [Stun]
[Grand Delta (8)] - Weapon deals a small amount of bonus untyped type damage
[Light of Penance (10)] - Target loses 6 Stamina and can suffer [Blind]

  [Razorfangs (3)] - Attacks have Double Critical Hit rate
[Bloody Claws (5)] - Attacks deal Bleed DoT
...
________________________________________________________________________
Natural Armor Gear Only Data Crystals:
[Self-Destruct (2)] - Explode on Knock Out, Death, or at Will, dealing Medium AoE Heat damage
[Spiral Spin (2)] - When directly attacked, reduce enemy's accuracy by 20%
[Diamondskin (7)] - You and nearby allies gain 10 Physical Resistance
...
[Blessing of the Salamander (6)] - +20% Heat Resistance. Can rapidly regrow lost limbs, Constitution is considered 2x higher
  ...
  [Lesser Visage of the Deity (4)] - +4 CHA. 10 Physical Resistance.
                                      ...
                                      Evil-Karma: +10% Resistance to Heat, Cold, and Sonic
         [Visage of the Deity (7)] - +4 CHA. Can see in Complete Darkness. 20 Supernatural Resistance, 10 Physical Resistance.
                                      ...
                                      Evil-Karma: +20% Resistance to Heat, Cold, and Sonic
[Greater Visage of the Deity (10)] - Can see in Complete Darkness. 25 Supernatural Resistance, 10 Physical Resistance.
                                      ...
                                      Evil-Karma: +4 STR, +4 DEX, +2 CON, +4 INT, +2 CHA.
										+20% Resistance to Heat, Cold and Sonic. Immune to Poison DoT and Sap DoT.
...
________________________________________________________________________
Runesmith Runes
Runes work differently from Data Crystals
Runes are either a increase to the item's base statistics,
Or a imbued spell with a chance of triggering when attacking or when being hit
  [Lesser Channeling (3)] - Casting Focus Rune. Casting time is cut by 25%.
      [Resistance (6)] - Armor Rune. Armor has 75%+ damage resistance, and degradation is halved.
 [Greater Weight (9)] - Blunt Weapon Rune. Damage is doubled, Knock Out and Stagger chance is increased,
                                            And weapon resists Disarm and Steal.

For active spells, grab the spell's equivalent and double its price.
Fireball is 3rd tier spell in D&D, so it is a 4th tier spell in Overlord, and requires 8 Data Crystal capacity to slot into equipment.
Incidentally, 6th tier or higher spells cannot be slotted.
        [Fireball (8)] - Weapon Rune. Chance to casts Fireball upon hitting enemy.
  [Cure Wounds (4)] - Armor Rune. Chance to slightly heal vitality when hit.

Be warned this section may be removed or reworked in the future, particularly base stat enhancing runes.
________________________________________________________________________
All Data Crystals are interpretations from 3.5/pf spell list, you can search for more by yourself, just add +1 to highest spellcasting level.
