#/NSG/'s Template
I'd like to state that the /nsg/ OP copypasta, the OP images I make, the 3 main pastebins, and any other content related to our /nsg/ is in no way proprietary. If you feel they are worthy of it, you are free to share, use, repost, link, and modify anything as you so desire.

Baking is specially encouraged, at any day of the week, and that's why this pastebin exists! Just use the tiny buttons to the right of the code style blocks to copy the text, fill in the respective fields, and bake away!
***
##/pol/ /nsg/
###Subject field
``` output
/nsg/ - ϟϟ National Socialism General ϟϟ
```
###Comment field
``` output
卐 THE GREAT NATSOC GENERAL 卐
...
>REDPILLS (LURKING NEWFAGS, CLICK THIS LINK!):
https://rentry.org/National-Socialist-Redpills

>BOOKS:
https://rentry.org/national-socialist-books
...
>VIDEOS:
https://rentry.org/National-Socialist-Videos
...
>SONGS:
https://rentry.org/national-socialist-music
...
Always remember to be respectful towards fellow National Socialists!
```
Reminder to self to add this when baking the weekly thread:
``` output
...
###Comment field
``` output
Thread for all webms related to National Socialism, White Nationalism, the Third Position, racial identity movements and the Jewish Question: speeches, short documentaries, edits, combat footage, redpills, propaganda, etc.
```
If you're going to bake both, please add a link to it at the end of the /pol/ /nsg/ OP.
***
...
[Template](https://rentry.org/nsg-template) *(You are here)*
