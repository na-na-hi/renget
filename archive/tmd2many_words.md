...
- However, some might construct what are commonly known as "Head Houses," homes that are meant to represent the appearance of the owner on the outside. These specific constructions were originally popular with wealthier tribal chiefs. Now it is a status symbol to show off that you have the income to afford an exotic style of home. It also lends itself to the general truthfulness expected of each other, now you know where your specific neighbors are!
...
- Each town or settlement usually has a handful of Adventurer or Exploration teams operating out of them. Larger towns might house one or multiple guilds.
- While monospecies villages or settlements are very rare, most will end up finding they live in a village that shares one common type. Of course, it gets a little more obvious if the village is underwater, but you get the idea.
