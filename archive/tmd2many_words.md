...
#### Guilds
Together, we're even stronger! Pokémon form Guilds (or just independent teams) to get benefits from having a large group of adventurers who are always willing to help one another out. Almost like a big family. Guilds construct their bases next to towns and usually have some form of specialty: Rescue, Exploration, Expedition, or even Justice... there's a lot a Guild can do.
...
**Badges**
Requiring long years of study, practice, and a natural attunement to the supernatural, badges are created from a distantly related process of TM etching and masterful crystal enchantment to imbue information and power within them. In order to maintain consistency in their production, blank badges are produced in advance and kept in safe storage, alongside recycled badges. They are fitted with the appropriate shell material and then given to their appropriate teams. As teams prove their commitment to the life of an adventurer, higher ranked badges reflect this change, as they are now made specifically for the team.

The badge bears multiple functionalities for the team it's been given to, attuned to their unique aura. Primarily, they are connected to the League's supernatural network, providing information for when requests are accepted, completed, and failed. Requests are designed to synchronize with the attuned badges, allowing the team to traverse to similar dungeon instances to find the target.
- Legitimate badges can be identified by briefly tapping two real badges together, in which case they will briefly flash basic information in the exchange, understood as a visible illusion between the two conducting the check. Tapping can also transfer information to blank badges, used mostly for ranks Rookie to Gold. Safeguards are in place to prevent undesirable transfers. This transfer does not work with personalized, higher rank badges.
...
**Zoroark Society**
Despite being able to manifest almost anything in their scope of imagination, Zoroark society places majority of their worth on physical and tangible goods. Authenticity and legitimacy in an item is paramount, and fraudulent things are looked down upon. While many might not be willing to risk their standings to try such things, few are bold enough to improve their counterfeit work to gain their fame. Even if they are not part of a community, Zoroarks are known to be materialistic. Hisuian Zoroarks, however, do not seem to care much for material wealth, and might even despise it. This places the two counterparts at odds, at times.
