...
\* ***Author’s Note:** this is a rewrite of the original “Map” story, which was published 3-5-23. It was the second story ever written for the Clover Guild, so it became outdated as the project’s canon became more solidified. This version is mostly identical, but contains some edits to fix inconsistencies. The original version can be found here:* https://rentry.org/e9e5p
