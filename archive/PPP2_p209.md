> https://rentry.org/PPP2_p209
```cpp
// Code derived from Stroustrup's PPP2 book
// § 6.7 Trying the second version
//  -and beginning on p 209
...
```
>*build & run:*
`g++ -std=c++20 -O2 -Wall -pedantic ./ch_06/main_p209.cpp && ./a.out`
!!! info *sauce:*
    [Bjarne Stroustrup's PPP2 textbook](https://www.stroustrup.com/programming.html) 
    [/robowaifu/'s official C++ learning textbook thread](https://alogs.space/robowaifu/res/18749.html#18749)
[Prev](https://rentry.org/PPP2_p206) • [Up](https://rentry.org/PPP2_ch06) • [Next](https://rentry.org/PPP2_p210)