# Anon.Doofus Cards - Collection, Card Spec v2 Cards
***
...
:---- | :----: | ----:
15/10/23 | 0/12 Published | Small update; I ain't dead, nor quit. Few more WIPs going up on Vol.4 "soon(tm)". / Really need to get around to final touches on Vol.3, and publishing them to Chub eventually. / Also need to fix the sizes of Vol.2 cards, some of 'em got cropped on Chub /)w(\
...
***
[TOC2]
![Vol. 4 Art is WIP.](https://files.catbox.moe/yq98gm.jpg)
***
...
NSFW | **LEAVE IT BLANK. KEEP THE "NSFW" ENCOURAGED OPTION CHECKED.**
