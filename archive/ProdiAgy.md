#Prodigy Guide for iA3: Complete Edition - August 2023 
#### -> written by a nerd who likes to optimize <-
###### -> “The reasonable man adapts himself to the world; the unreasonable one persists in trying to adapt the world to himself. Therefore all progress depends on the unreasonable man.“ <-

!!! warning Fixed iA3: Folder captioning was broken until now on bmaltais/kohya_ss, completely redone this page according to the now correct usage of folder captions, there are a couple things that are adjustable and overall this is by far the most simple and fastest way of doing it seen yet. Will be updating the completely wrong models that were put on iA3 soon. Hint: iA3 is extremely impressive, better than everything else.
...
[iA3 is like TI for the UNET and done at a very small size, about 200kb, works amazing on both characters and style. Very lightweight. Consumes the least amount of VRAM. Eats a lot of learning rate for breakfast. ```iA3 can be done anywhere from 100-800 steps if your settings are correct and depending on what you train.```](https://huggingface.co/docs/peft/conceptual_guides/ia3)
