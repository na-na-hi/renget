# Maestro's Bot List
## -> [Original Bots](#original-bots) - [NIKKE Bots](#nikke-bots)	-	[Other IPs](#Other-IPS)	-	[Lorebooks](#Lorebooks) <-
***
-> ==Latest Update 08/07/2023== <-
-> *Added to Original bots: Amelia Richards [CAI + Tavern]* <-
-> *Added to NIKKE bots: Helm [CAI + Tavern]* <-
-> *Added new Section: Other IPs* <-

-> ==Previous Update 06/29/2023== <-
...
Helm | ![Helm](https://i.postimg.cc/NfkCfTVc/Nikke-Helm-Thumb.png) | Leader of Aegis, a naval squad formed for combat on the surface. As there are no oceans within the Ark, she trains her members to face real naval combat one day. | [C.ai](https://c.ai/c/yJExv2zCbAYNVJzaft9zGoHbPgCVqvowElu7l3xcdaU) [Tavern](https://files.catbox.moe/f33gnx.png)	v1.0
