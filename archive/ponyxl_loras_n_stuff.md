...
You can also help nudge generations with the model more towards anime style by using "source_comic, source_furry, source_pony, sketch, painting, monochrome" in the negative prompt when generating images. Some of the artists with more subtle art styles tend to have more success with this in my experience. The bias is a bit less evident in the lower scores so if you were to tag your images with score_9 (assuming you used score_9 in your lora) then have the prompt be something like "score_9, score_6_up, score_5_up, score_4_up, source_anime" then you might get better results. Unfortunately this also makes your LoRA harder to use, you'd have to tell people to use it this way.
