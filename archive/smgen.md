...
Literal modified Wikipedia blurb aside, you already know what a MOBA / ARTS roughly looks like, so let's get down to the obvious comparisons with the genre.
...
The key driving aspect to SMITE carving out it's niche, is that it departs from the MOBA genre in a few notable ways:
 - Most obvious is the unique **Third Person PoV** and resultant higher theoretical gameplay skill floor than it's two major competitors.
	This brings two major things to the table - firstly, you are far more functionally blind compared to the Top-Down MOBAs, as enemies can walk up behind you almost completely unseen *(provided they stay out of your field of view)*. This makes ganks potentially more deadly, but also gives more immediate information to th eplayer (as your view distance is generally far greater than that of a Top-Down).
	Secondly, is that there is a much more tangible and immediate skill aspect to the game - you need to aim and lead your shots far more, can choose to make shots at ranges you are not guaranteed to land them at, and as a melee fighter, you need to keep your reticle on your target. While that sounds seemingly minor, it adds a more direct *gameplay* aspect compared to their Top-Down variants. This isn't a point-and-click adventure, where Basic Attacks auto-lock once fired - you can miss your shots.... all of them.
 - Another major difference between SMITE and others is it's **map complexity**. In their flagship modes, LoL and DotA 2 have typically square maps, with each team occupying a triangular half of it - SMITE instead opts for a more hexagonal map in it's flagship mode. This suits Third Person better as sightlines are longer, affording more visibility down lanes by default and lanes themselves are much wider, allowing for teamfights to have ample breathing room. Bouncing off of this, SMITE's jungle region is also much more complex than that of LoL or DotA, with multiple extra objectives for the Jungler (and co.) to occupy themselves with - and no river - forcing more complex pathing throughout the Jungle. While it lacks the map-manipulation of DotA 2's trees, it is still the map with the 'most to do' on it.
 - In other modes, SMITE has a far **more active / evenly spread playerbase outside of it's 'main' mode**, with many people even sticking purely to these 'less serious' / 'more casual' modes. These range from the typical ARAM *(All Random Gods, 1 Lane)*, to Arena *(no real objective, just a 10-15 minute teamfight, very very popular)*, to Duel / Joust *(1v1 / 3v3 on a smaller map)* and a variety of other modes - even including semi-common high-effort Events, with completely unique rulesets and custom made maps.
   If you don't like the 'main mode', you have options - which is far more than can be said for SMITE's competition, each of which boils down to *'the Main Mode only + maybe ARAM if you're lucky and playing primetime'*.
 - **lmfao it's the only MOBA that regularly gets (actual) new content**.
	...
	You like skins and customisation options? SMITE has the largest skin cycle of the three, averaging 10-20 skins per month, with a variety of established and original themes *(ie, not 1-skinline-per-patch)*, on much higher poly models than the ones found in DotA2 and LoL *(complete with custom VFX, SFX and occasionally, emotes and Win/Loss screens)*.
 ...
 - Finally, once you're used to the game, **Gods in of themselves are much more customizable on a match-to-match basis, with no out-of-match gameplay-affecting progression**. In other words, they can be played much more normally outside of their classes 'usual' role, and there's no such thing as Rune Pages or the like, so every player plays every God to the same potential at the start of the match. The only differing factors between two identical Gods on a new player and an SPL pro-league player is itemisation, ability progression throughout the match and pure skill. That, and Guardian Junglers or Mid-playing Gods in ADC are normal and viable (if unorthodox) - provided they can fulfil the basic demands of that role.
   This is also in due part with the much more **accessible Shop system**. Gods Stats are much more dependent on the items they have over their base level-scaling (to a degree), and the Shop is only split between whether your Damage type is Physical or Magical. There's only a few Tier 1 items, which each branch out into a multitude of more complex Tier 3 items with additional effects that generally all fit within a given idea *(for a few examples; everything on the Katana tree benefits Physical Basic Attackers, the Talisman tree is mostly focused on Magical Defence stat-building, while the Ancient Blade tree is a tree designed for utility counterbuilding)*.
...
That said, I'm not here to give SMITE a handjob - it lacks the mass-popularity of League, and the ultra-autism complexity, depth and macro of DotA 2. *While there are some very complex kits, it doesn't have any 'extraordinarily' complex kits; such as the Invoker, Arc Warden or Meepo from DotA 2, nor does it have anything like the 200-years Aphelios of LoL .... Yet. ~~/ any more, RIP pre-Rework Persephone / Hydra's Set~~*. You are not going to impress needy, fatherless, groomable e-girls by playing it, and you're not going to garner the respect of the elder-neckbeards for being good at it. It occupies a middle-ground between DotA 2 and LoL in many ways *(closer to LoL)*, while doing many things completely unique by itself. To say the very least, it's no copycat.
If you're moving over from LoL or DotA 2, there will probably be a few Gods that you're comfortable with *(for example; Susano plays similarly to Yasuo, Maui hits a lot of Thresh's notes, while Artemis and Neith are two aspects of Sniper)* - just ask for comparisons within the thread if you want more detailing, ~~or see the dedicated bit for it when it's done~~.
While there are many other differences that really set it apart from the body of the genre *(Higher TTK, Minion Collision, Minions having times when they can hit like trucks if left unchecked etc)*, you'll just need to learn that with experience - I wouldn't have enough time to detail them all.
...
### Before a game
 1. Jump straight the fuck into Jungle Training / Practice. It's a Godsend of a mode, and has everything you could ever want while new. Try a few Gods, but most importantly, mess around with your Sensitivity and HUD until you're comfortable.
	...
	- For HUD, move the minimap closer to your reticle - not obscuring it like a retard, but close enough that you can very easily look at it. The rest of the HUD is fully customisable; aside from the near-mandatory minimap, move the rest around according to your personal function (more important = higher priority)
	- Quick Casting vs Instant Casting is the debate of our age. Quick Casting lets you line up your shots, Instant Casting gives minimal delay but immediate investment. If you're new, I'd easily say go Quick, then gradually move over to Instant if you're down for it. As a bonus, if you do so desire, you can also change casting styles on a per-Ability basis (Menu -> Abilities), for when one casting mode is especially useful - such as Instant on escape abilities *(which you don't need to see a reticle for)*.
		Never Normal Cast, it's a waste of time.
	- Other options; Ruler is the best Distance Line, Enable Bracket Highlighting, No Reticle and change Ground Reticle to taste. Turn Help Tips off, turn Ward Ping and Jungle Markers On. Change the Personal Health Bar / Health Bar Scale / Opacity to taste.
 ...
 2. Turn off Auto-buy on Items ASAP. Auto-Buy items are notoriously bad and ill-suited to Gods (which is why you should just ignore it); meanwhile the 'Recommended' only shows the items most commonly built on a God *(which means you'll be getting the selections of the lowest common denominators, and often miss some good synergies)*.
 3. Auto-Level is more complex - if you input the level progression you want in advance (within the God section from the Main Menu) and your God only has one 'meta' role, it can be fine to crutch on it while you're learning how to juggle every other mechanic in the game during play - but for Gods who can play multiple roles or matches that require adaption for counterplay, it's not simply a case of one-build-fits-all.
	For new-player intents and purposes, the 'usual' Ability plan is to put 1 point in and unlocking each of your abilities, then maxing your best minion waveclearing ability first, then your next best attacking ability, then the remaining ability - all the while putting a point into your Ult whenever you're allowed. There are outliers, you'll learn them in time.
 4. If you plan on playing a God, try to make an item loadout for yourself in advance; even if you're just duplicating somebody else's *(in TCG terms, netdecking)*. You don't want to be spending valuable time lingering in spawn picking and choosing what to build, and if you're new, you probably won't know what's good for your God pick or what's meta - with a good chance of accidentally hitting a stat cap (e.g. trying to go above 40% Cooldown Reduction) and wasting Gold. While ones you'll find online may lack detail or personal taste; in terms of getting you the basics for a God, they do help;
	I'd go further to say that once you're comfortable with the game and have a few hours down, go back into the God menu, and make an item loadout for *\*every*\* God you have unlocked - it'll take a while, but is the fast-track-way to learn the item shop and the current meta, as you begin to see similar recommended items pop up. From there, you should become more comfortable as you begin to work on homebrew builds and modify item builds on the fly during matches to fit a scenario. Come back to do builds for the free rotations too - it'll further feed into self-teaching, clean up ship builds and will slowly get you full builds for Assault.
	- The first 3-4 items you take should make up the body or 'core' of your build.
		While pre-choosing a 5th and 6th item is useful for a 'smooth game', the simple fact is that most games don't even last that long, and those slots are often reserved for counterbuilding or for one of your core items to be built later, if you needed an important counterbuilding item ASAP *(like the always-important-if-present AntiHeal ,or the situationally hard-countering AntiSlow)*.
	- A 'typical' template /diy/ build will include a Starter, one stacking item and some cooldown. Tanks take the type of Protection they need first, while Damage will take the type of Penetration they want first *('flat' Penetration better into other Damages, % Penetration better into Tanks)*.
	- It goes without saying, but lay out your builds in a way that you'll know what your past self meant, once you get into a match. Don't just randomly throw in items - ignore the 'categories' of each row, and design it with your item progression in mind.
		Personally, I use the 1st row to indicate Starters and the first item of a build, the 2nd row to indicate the other four items I'd want for a match, then another / offrole build in the 3rd and 4th row if a God can play multiple roles, and then save the 5th row for Situational or Alternate items *(especially the lowest tier items in useful item trees)*. Past a certain point you'll be able to dip into the rest of the shop on the fly *(making custom item builds less important)*, but as a new player this'll save you a lot of hassle.
...
###During a game 
 ...
 4. Enemy minions that are damaged by your Tower only give 25% of their usual Gold reward - so if you're pushed under your tower, focus on the minions that the tower isn't attacking to mitigate the Gold economy loss. All minions will give you full EXP reward providing you're not splitting / being leeched, so **don't get caught up over keeping them off the tower line**. It's completely fine to just sit under tower and recover health - a death is far, far worse than losing some farm.
 5. On the topic of Towers - if you attack an enemy God under a structure, the structure will ignore any Minions (not Gods) damaging it, and attack you - *which is why you should decide if you're going to either attack the tower, or bite the bullet and attack the God while eating some tower shots. Not both at once*. Aside from this, a structure will not change aggro until it's target is either dead or out of range. Structure Attacks are auto-aim, auto-tracking and will *always* strike once fired *(even if you teleport across the map, like with Athena's Ult)*.
 6. The best way to juke attacks is by moving forward while turning with the mouse / right analog stick *(aka Tank controls and ZigZag)*. Strafing sideways and backwards lowers your movement speed, along with the Basic Attack movement penalty if you try to attack while doing it. Also, there's a very slight amount of acceleration in the way you move, meaning you can't spin around and throw an Ability at your pursuer without slowing yourself down. **If you're being chased by the enemy team, do not turn around until you're more-than-confident you're safe.** Don't even risk it. If you want to leave them 'gifts' in the form of delayed AoE Abilities, just throw them in front of you, run through them and detonate them when you think they'll be on top of it.
 7. Get familiar with the ingame voice-command-system (VGS System), which you can use to issue commands such as setting up a gank, calling for defence, or pointing out a MIA enemy from your lane (who might be roaming around). Hit V on your keyboard (or if on controller, left on your D-pad) to bring up the list and the corresponding prompts to call out what you like. The VGS system has a bit of a skill floor, but is worthwhile to learn, and everything you could ever need to say is *somewhere* in it.
 ...
 8. In terms of noob relics, the infamous one is Meditation Cloak, because noobs often play far more aggressive than they should, and crutch on the healing. While each role will always have it's own Relic meta, Purification Beads and Aegis Amulet *('free CC immunity' and 'iFrames in exchange for no actions')* is the usual 'de-facto' loadout if you can't think of anything else. Teleport Glyph, Blink Rune and Magic Shell are other common ones depending on role. The sole exception to this is on the Assault gamemode, where the otherwise complete lack of healing and constant teamfighting makes Meditation Cloak a must-pick first Relic.
	Additionally, while the concept of forcing players to 'burn' relics comes into play once you git gud, for your newer experience, it's better for a Relic to be on cooldown all match, then never be used.

**And finally / most importantly**
 9. **Calm down with the aggro.** The major newfag mistake is playing way too aggressively, and needlessly dying. Trading deaths is ~~usually~~ not a viable strategy in SMITE (or MOBA's in general), as you'll be putting increased strain on all your teammates, as the enemies get a passive Gold and EXP boost (on top of getting free 4v5's). This is a genre where a difference of 3+ levels is a pretty difficult task to play into.
	...
	While this becomes more irrelevant later on, as you begin to get some combined gamesense as to how aggressive you can be *(and what cues will and will not lead to easily avoidable deaths)*, the difference between bad enemy positioning and them baiting you, and when you should poke for kills; in your early learning stages you should really just play more passively. Not passive and being a bit aggressive where you think you can get away with it, I mean passively and passively - hug towers and Supports, they'll keep you safe, and run from gangs of enemies when you're on your own. An end K/D/A score of 1/2/6 is far more valuable from a new player than 4/14/5 - keep that in mind, and you'll be getting 27/4/15's in no time.
...
*I'm going to make this as painless as I possibly can. You'll hear a lot of stuff you already know, but I have to lay everything out, as there's quite a lot of stuff that's either hidden or confusing.*
 ...
 - Attack Speed
	...
	- Progressive Basic Attack chains vary the time taken to perform a Basic Attack, and affect damage of that Basic Attack by the same degree.
		If a God has an attack chain of 1 / 0.5 / 1.5 and an Attack Speed of 1, their first attack will take 1 second and deal 100% of their Basic Attack damage, the next will take 0.5s and deal 50%, and the last will take 1.5s and deal 150%.
	...
	- The Attack Speed cap is absolute. No matter what you do, nothing in the game can go over 2.5 - resulting in 2.5 Basic Attacks per Second on a 1/1/1 progressive chain. While you could fit more attacks in, if your progressive chain allows for it *(eg, Charybdis's 1 / 1 / 0.3 / 0.3 / 0.3 cycles through her chain at the same speed as 1 / 1 / 1, but the 0.3's will have a much shorter delay, and so she can fire more in that time)*, an Basic Attack with a chain value of 1 cannot exceed 2.5 Basic Attacks per second.
	...
	- For most examples, using an Ability *(or a Blink rune)* will completely reset the progressive Basic Attack chain. For Gods which have a notably low delay when using their Basic Attacks, this means that they can essentially ignore their recovery animation and 'fit' more damage into a small period, with minimal time lost and while ignoring the 'slower' Basic Attacks that may come later in the chain. Gods take a while to fire their first Basic Attack in a chain (in relative terms) are deemed 'unable' to do this, as the time taken to attack is not worth resetting the chain for.
 ...
 - Protections / 'Prots'
   ...
   - Long Answer:
         ...
         - Unlike Power, the Prot Caps of 325 cannot be exceeded via most conventional means. Flat Prot Passives, any Flat Prot Buffs from Abilities, Item Effects, Potions, Jungle Buffs and any other God's Abilities or Auras will NOT allow a God to exceed the Prot cap.
			The only way to break the Prot Cap is to be under the effect of a % increase during an Ability. For the most 'common' example of this extremely niche scenario, if a Support Sobek or Hades ends the game while Ulting, you may see in the post-match screen that they will have exceeded their Prot caps, as their Ult gives them an unconditional % increase to their Prots.
         - The full calculation is (Raw Damage \* 100) / (Prots + 100).
			...
			1. For Gods building Penetration, the difference between Unmitigated Damage and 'any' Mitigated Damage is very noticeable. This is why a Scylla with 800 Power and only the 15% Reduction on her AoE is MUCH LESS dangerous than a Scylla with 600 Power but with 65% Reduction and 30 Flat Reduction. The Unmitigated Damage will do *\*exponentially*\* more.
			2. For Gods who have low base Prots, a small amount of Prots is exponentially more valuable. The 15 Prot Aura from Heartward Amulet is far more valuable to the Agni with less than 100 Prots, than it is to the Sylvanus with over 300 Prots. Likewise, this is why is can be valuable for some hypercarries to slot in one Prot item *(eg Magi's Cloak)* - the few Prots they gain is worth far more to them than it does a Tank, and their Power is still high enough to be able to do their job of blowing up a backline.
 ...
 - Penetration / 'Pen'
   ...
   - Long Answer:
         ...
         - Shred / Theft is still either Flat or %, and reduces the Protections of the target *(affecting their damage taken from all sources)*, rather than reducing the Protections from just your damage. 
         - Flat or % can be limited to Physical Protections or Magical Protections. If it isn't specified, it's reducing both.

 - Damage Mitigations, True Damage and Executions
	...
	- 'Damage Mitigation' *(sometimes referred to as Mits)* is more accurately 'True Protection'. This time, it is really is 'True' Protection. *Yeah, it's annoying.*
		This is the final part of the damage calculation, and will always be accounted for. Since each instance is reduced by a percentage, individually *(not additively)*, it is almost impossble to take 0 damage / stack to '100% mitigations'. If you don't understand, you should have paid attention at school.
	- There is no difference between Mitigations and 'Reduced Damage Taken', or anything along those lines. 'Reduced Damage Dealt' applies all damage output, by the target under the effect of the debuff.
	- While Damage Mitigations / Reductions are almost always in % *(to keep it balanced / to prevent 100% mitigations)*, there does exist Flat Reduction, which will reduce damage taken by that set amount under the same logic as Mitigations, from ALL individual sources of damage.
		*For example - you get hit by Ah Puch's Antiheal Grenade, and because you healed, you're in for two instances of damage. Each instance would be reduced by the Flat Reduction. Additionally, if he's built Soul Reaver and you're hit with the Item Passive, that too is also reduced by the Flat Reduction. Additionally, he's also built Conduit Gem, and you're hit with the True Damage Item Passive on that..... that too is also reduced by the Flat Reduction. On one Ability, the Flat Reduction applies to all 4 instances of unique damage sources individually, for x4 the indicated value.*
		As of writing Flat Reduction only exists on one Item, no God Abilities, and is extremely small - and despite this, it is the most potentially valuable stat and game-breaking in the game if left to balance oversight. ~~Can you find it?~~
	- Executions are not accounted for in damage calculations.
		If you are below the threshold given and are Executed, your health is immediately set to 0, and any post-death effects do not activate. As of writing, the only three executioners are Thanatos, Ao Kuang and Achilles; while the only 3 interactions this has, is with Khepri Ult, Persephone Passive and the Alternate Timeline Item Passive.
 ...
 - Lifesteal, Antiheal & Healing
   ...
   - Long Answer:
		...
		*For a good spread-example, Fafnir's tiny leap AoE and his huge Ult-channel AoE each equally are reduced to 33%, however his single-target, non-penetrating Hammer throw benefits from 100% Lifesteal healing.*
         - Antiheal applies to \*all\* forms of healing. This includes Ability-Heals, Liferip on Minions, Liferip on Jungle Camps / Bosses, Map-Health-Pickups , Consumable Healing, HP5 and even Fountain Healing.
         - Global Antiheal is active at all points in a match (represented by the Green Hand debuff), and is only de-activated for the duration of 'combat' *(currently for 4s, after taking or dealing Damage or Hard CC)*.
		This is apparently to prevent ~~Yemoja~~ ''''''Healers''''' from making the game a slog at upper levels. Unlike 'standard' Antiheal, it uniquely does not affect the healing from HP5, Map-Health-Pickups or Consumable Healing, but still applies to all other sources. Don't worry, nobody else likes it either.
         - Healing Increase can be considered as the 'flat counter' to Antiheal. 40% Global Antiheal is reduced to 20% Antiheal while a 20% Healing Increase counters it.
		Additionally, on top of all previous forms of healing mentioned *\*(even including HP5)*\*, Healing Increase increases the healing from %Max HP Healing and %Missing Healing. A God with 2,000HP that would heal 1,000HP from a 50% Max HP heal, will recover 1,200 if they have a 20% healing increase buff applied.
 ...
 - Movement
	...
	- There are softcaps and hardcaps to Movement Speed.
		Don't worry, you'll never reach them and will barely notice them - even if you 'try' to max out your Movement Speed *(just like how Basic Attack damage is capped at the impossible 10,000 damage)*.
		If you do care, the first Softcap is at 457 *(reducing additional Movement gains by 20%)*, then at 540 *(reducing by 50%)*. The Hardcap is at 753.55 *(because the engine can't process past a '1,000' value found within the default Movement formula, and 753.55 is the maximum value possible before it hits that - it may 'show' more, but you will not go faster that)*. Unless you're making a full-Movement test build in the Practice range, you will rarely *(if ever)* reach 540, and will not notice when you're past 457.
	- This is only for your default 'running around'. Dedicated Movement Abilities such as Dashes and Charges operate on a different formula.
	- The fastest default-Movement Gods in the game are Mercury and Chiron *(Mercury technically out-pacing Chiron's base movement speed by 1, because easter-egg detail)* - each moving at ~5.8m/s. Considering Passive Movement abilities however; Amaterasu, Awilix and Lancelot are faster in practical terms.
	- The slowest Gods in the game (who have no additional Combat Movement) are Hel and Nu Wa, moving at 5.41m/s.
	...
	- From Level 1-8 of any match, your Movement Speed will increase by 3% per level, to an 18% increase. This is because there used to be a dedicated items to Movement Speed (Boots), however they were so fundamental to get early, that it was just incorporated into the Base Mechanics to allow for build flexibility.
		Since this is a % increase, it does not influence a God's base Movement number, only scale off of it.
	 - Depending on your actions, your Movement will be subject to Movement Penalties;
		...
		Only the highest single penalty applies at any time - hence, you have the same Ranged Basic Attack penalty in any direction you move. Since looking behind you means you are moving sideways and backwards at some point, you will slow down when doing so.

	 - The Jump button does actually have a function in this regard that isn't just a tiny self-knockup + silence. While jumping, you will retain the speed you are moving at until you land. This can be used to look behind you if you are being chased, without losing movement speed. Niche, but it does work.
	- 'Mounted Horseback Movement' is Tank Controls. As of writing, this applies the Guan Yu Ult, Hachiman Ult, Chiron's Charge and Lancelot's Horseriding. The Horse will constantly move forward, so you can only control if it is turning Left or Right. As a result, you use your aim to look around independently of your Movement Direction, without incurring a Movement Penalty.
 ...
 - CC, Diminishing Returns / CCR & Slows
   - CC is the acronym for Crowd Control, the factor of an Ability to control the movement or positioning of an enemy, without necessarily damaging them.
		...
		This includes Slows, Cripples, Deafens, Blindness, Vortexes, Roots and Torment / Insanity.
   ...
   - Diminishing Returns (DR) \*used\* to be one of the least understood mechanics in SMITE, but with it's elevation into a visible stack on the buff bar *(the little blue / purple guy going super saiyan)*, they're quite straightforward to understand now. When hit by CC of any kind, you'll gain a DR stack, which reduces the duration of the next CC instance by 20% (unless it's True Hard CC), up to a cap of 4 stacks, or 80% reduction. Additional DR stacks refresh the duration of all stacks built up.
		...
		Soft CC gives 1 stack, Hard CC (and True Hard CC) gives 2 stacks. Being Cleansed or using Beads still retains all DR stacks built up. Stacks currently take 15 seconds to fade, unless refreshed.
   ...
   - Slows are the most common CC in the game, and have dedicated caps and mechanics, as they are uniquely accounted for within the Movement calculation.
 ...
 - Auras
	...
	- The only exception are Auras that directly deal damage (eg Cu Chulainn's Steam) or steal effects (eg Cerberus's heal-steal aura). In this case, identical auras do stack, as they're considered multiple conditional AoE attacks, rather than buffs / debuffs.
...
## -> Additional Jargon Glossary *(of the stuff you actually want to know, and are not told)* <-
 ...
 - Boxing = Two Gods aggressively zoning into each other with attacks, trying to force the other away while taking minimal damage *(like how two boxers will fight each other by throwing punches, while ducking and weaving)*. Unlike normal zoning, if a God with worse boxing ability tries to dive a God with better boxing while both are aware, the worse will almost always die, making it something to consider when engaging. To be 'boxed down a lane' is *\*not*\* to be indirectly zoned down, as much as it is aggressively *\*forced*\* down.
 ...
 - Meta = You do know Meta / META is an acronym, not a Noun, right? ~~It's certainly not what Facebook thinks it's called now, that's for sure.~~ **M**ost **E**ffective **T**actic **A**vailable. The more you know!
...
If you are absolutely brand new, I would genuinely recommend you just ignore Conquest for a while. It's not that I'm trying to put down your fun, it's that you'll have more fun if you know roughly what's going on (objective-based strategic gamemodes work like that). Get familiar with the gameplay in Arena, get familiar with the idea of laning in Joust, then when you've got the basics down, jump into Conquest. If you want an account-level-range, you don't need to put it off forever, something like Acc. Level 10-15 should be fine enough.

 -> https://rentry.org/smgen_Conquest <- 

   -> ![Conquest 10.2](https://files.catbox.moe/xvoadp.png) <-


### Arena

A 5v5 revolving around tickets, where you're pretty much permanently in a teamfight. 
Probably the most straightforward gamemode on the list, the most accessable for new players and the one with the most players outside of Conquest *(which they affectionately call Cuckquest in response)*. If you know how to play it, this mode is borderline impossible to be snowballed in.
*If.*

Minions spawn regularly, run down from their Phoenix to centre, then follow the same lane a bit, before running to a Portal. Dealing damage to a minion at any point before it dies deducts a ticket from their team, but an enemy minion reaching your portal deducts a ticket from your team.
Every 10 player kills, a Minotaur spawns, and run down with the same pattern - with the key differences being their health and AI. By default, they act as normal minions, however if 'escorted' (with any allied God near them), they will ignore *all* enemies and walk forward. In ticket value, they're (currently) worth 15 tickets if they reach the Portal.
Your respawns are also shared - for most deaths, you'll get back in instantly. ~~Since the wiki (and the 'Overarching Arena Guide') are made by retards / ledditors (*what's the difference, hey?*), they only have this unhelpful quip, so I'll explain in further detail here than what you'll find there.~~ At the start of the match, each team has a collective respawn of 10s - this means that everybody has that time upon death assuming Ticket lead is equal. One guy dies, then the rest of the team is wiped 9 seconds later, they all respawn 1 second afterwards. Depending on the ticket imbalance, this will scale upward and downward, to up to 60s (at ~100 Ticket difference).
...
As for any other things to know:
 - You get a passive 12 Gold per second in this gamemode - quite a lot. *As in, it's something like 90% of your income each match.* If you can't afford something, sometimes it's just better to wait than spending the next few minutes scrimming without it; especially items which require stacking *(Gauntlet of Thebes, Charons Coin etc)*.
 - Gods with good combat mobility thrive at getting EZPZ kills in this mode - Gods like Bastet, Hun Batz and Susano thrive in Arena, with their ability to get in and out within one Ability rotation and picking off choice targets from anywhere on the map.
 - Aggressive Guardians with strong teamfighting / zoning thrive in Arena, simply because the entire duration of the match is one big, long teamfight. Jormungandr, Cthulhu and Kuzenbo are all disproprtionately stronger as maintanks, and building Auras likewise benefits their teammates much more.
 ...
 - While 'carrying' is relatively hard in this game, there's a few things you can do at match start to net yourself an early lead;
	...
	- Second, if you're not Support, and you're not one of the Gods that wants a buff, ignore them, head to the lane first, clear the wave and escort it to the portal. If the enemy doesn't deal with the wave *(which they rarely will, because Arena)*, your team essentially starts the match with a Ticket score 2 kills ahead *(1 for confirming a kill on their wave, 1 for getting your minions to their Portal).*
 - There is nothing wrong with chasing kills in this gamemode - under the sole requirement you confirm / trade. Invading the phoenix region (not spawn) to confirm a kill and trade is actually a high meta strat - as it maintains the same ticket difference as before, while giving you an instant teleport back to spawn (if you were that low anyways, you wouldn't have got back anyways or contributed to the team any more). ~~If you're a real cocky bastard, invade the spawn itself - but note you've got less than a second to confirm your kill as they hyper-regen.~~ Keep it in moderation however - just because it's viable doesn't mean you can dive their spawn every push.
 - There's an alternate version of Arena that occasionally pops up, called Corrupted Arena. The key difference is that the floor itself breaks away over time - so any god with push-back or throw (eg Geb, Sobek, Anhur, Hercules, Charybdis) becomes able to get instakills. It's a Xing Tian paradise. ~~Also jihadi Kuzenbo's.~~ Another variation / addition to the theme is that a match ensd with a final 5v5 showdown *(independant of the Ticket-winner)*, which rewards a bonus amount of end-of-match rewards.
 - Da Ji, Maui and Ares can use their Ults within spawn; making them all instakills.
 - There is a special place in Hell reserved for 'people' who play max-cooldown Support Nox in Arena.
 - **Never, ever, trust a Horus Ult in Arena until you directly see exactly where it's going.**
...
Since you can't really choose your godtoon, there really is no 'meta'. In terms of gameplay, you'll usually have an emote-off until minions spawn, just poke at each other a bit until you get strong enough to bust a Tower (~Lv8-10); then it's a tug of war as both teamfights try to barrel through the Titan ASAP. Really not complicated.
...
There are still however, a few core gameplay aspects and tips you ought to take into account to greatly increase your winrate in this most casual of modes:
 ...
 1. **Always grab Meditation Cloak.** This is probably the most obvious aspect of Assault, but if you're new it's because 5 players popping Clock at once is a 100% heal over 4 seconds, and is vital for the high-aggro high-teamfight aspect of Assault to constantly keep you topped off. Use it whenever you notice it off cooldown, you basically can't waste it. Furthermore, on the topic of Relics, once you're at 2nd Relic (or if you're feeling risky, before Cloak), it's highly preferable if at least one player grabs Bracer of Radiance, as, much like Cloak, the entire team can benefit from it disproportionately so compared to other modes. 
 2. Likewise, alsways assume you're playing into a high-heal composition. **Antiheal is disproportionately stronger in this mode**, and everybody ought to be running it (and early) if possible
 3. If nobody has bothered to do it - regardless of if you're a Guardian or not - **somebody should build Auras** and play Support. Even if you're a Support Mercury or Support Medusa, it's better than a team of 5 Hypercarries with no sustain - everyone is close together, so everyone benefits.
	In relative order of whenever you should grab them (personal judgemenr aside); Auras that grant MP5 are very valuable early on *(as everyone will run out of Mana quickly)*, followed by auras that affect structures *(or Physical Protection in general, so you can tank shots)*, followed by auras that provide AoE Protections. Don't forget Auras do not stack - if somebody else has one, build something else.
 4. **Focus the Structures** over Players - Towers are permanent, Kills are temporary. Sounds obvious, but much like Antiheal, often goes ignored.
 5. **Taking the right-hand way around the wall from Spawn is usually faster than going left**. It's also the side you want to attack the Titan from, as it's the route minions take.
 6. For the final aspect of non-God-specific gameplay that comes with Assault - **learn how to stall and cuck the enemy**. Since the entire gamemode is teamfights kicking off constantly, there's a good chance you'll at some point find yourself the last chimpanzee alive on your team - at which point, you get to grin, as it's just time to fuck with the enemy ~~for fun~~ for vital strategy-plays:
	...
	- If you were in the middle of a teamfight, and are the only one left because of your bulk - again, ignore the enemy, and charge straight forward to pull them down their lane, ignoring their towers too. The will almost always chase you - doubling their journey to your front line - so your teammates have more time to respawn. There's a little bit at the back corners of their titan which is a golden zone - if you can reach here, no matter what, the enemy will be completely unable to reach your phoenix before your team respawns. Popping Aegis, using immortality-ults (Kali / Freya / Camazotz), harassing them so they can't ignore you or just juking attacks will increase your stall time in this scenario.
		If they do ignore you - *that's fine too* - just use Cloak selfishly to heal up, steal all the orbs, deny them every single minion wave, harass their respawns and then, *(ONLY if you haven't done any damage to the Titan; as it will contiually heal if you do this)* pull and drop Titan aggro to continually fill their screen with 'YOUR TITAN IS UNDER ATTACK!!!' messages until they come to janny you up (for free).
...
3v3 down a single lane traditional lane, with a small jungle on both sides.
The definite 'third' gamemode (the SMITE of SMITE), Joust has came in three major flavours in it's history - Classic, Chinese and Corruption.
 - Classic is a single lane with a thin, ring jungle with 3 buffs (overall, based)
 - Chinese is a single lane, a more complex jungle layout, with only 2 buffs but also a unique jungle boss, that if killed shuts down the first structure.
 - Corruption / Chinese Corruption is a single lane, the most complex jungle layout, many jungle camps a unique jungle boss, that if killed shuts down the first structure.
In terms of how the maps play out, Classic is the most defender-ended, with a notoriously difficult to push Phoenix and slower but more 'honest' games due to minimal farm; Chinese is a balanced map that equally encourages both aggression and macroplay; meanwhile Corruption is the most farm-ended map, but also the most aggressor-favored map *(resulting in high snowball potential)*.
In terms of teambuilding, you'll want a Tank, then two DPS's of opposing damage types *(so usually Guardian / Mage / Hunter, Warrior / Mage / Hunter or Guardian / Mage / Assassin)* but as much of a playerbase as this mode has - it's honestly not that unique. It's just a Conquest lane - 1 tower, with 3 people in a teamfight and none of the wider multi-lane strategy or consideration. Teamfight during minion waves, pick up neutral farm as much as you can whenever it's up. It's really, really simple *(but honestly, don't forget to farm those neutral camps, they add up)*.
It's both Joust's greatest pull and draw - if you want a quick and simple game, it's perfect.... if you've got the time, why not anything else? Great for when you just need to grind out some wins, and are confident in your skill / don't want to roll the dice as much with Arena.
...
You will find no mercy, no kindness, no quarter given in this gamemode. Everybody is a tryhard of the most extreme and petty kind here.
This is where people use Skin Advantage deliberately.
This is where people recognise in-game names and target-ban a player's main Gods.
...
2 lanes, 5 Gods with a small central Jungle.
...
And all this is on top of the Juggernaut mechanic.
...
Slash comes with two unique mechanics - Juggernauts and Apophis. With them, let me explain 'how' you 'play' Slash.
 - Juggernauts are Siege's contribution to this gamemode, and are in summary the only things you need to give a fuck about, outside of teamfights. Jungle camps aren't worth farming on cooldown, but these are
	Functionally, Juggernauts are bulky Archer-Minotaurs, designed to force your way down a lane, and give you a way to head back to base while losing out on no farm. **From match start, you're going to do nothing but teamfight for the first 4 minutes and you will not head back to base unless killed.** Why is this? Because at 4 minutes, the first neutral Juggernaut spawns in on the Egyptian side - defeat it, and it's a free ticket back to base without losing any farm. **The team that takes the first Juggernaut has a 63% chance of winning the game.**
	Once the Juggernauts start rolling in, is when you try to group and snowball your lanes. At 10 minutes the sided-Juggernauts spawn in, but by then one team should have shoved their way down a lane. This is also why the game is extremely snowball-y - whoever breaks the first Tier 2 Tower gets free access to the enemy teams 'reserved' Juggernaut, which is often the case before it's even spawned in. If the defenders do manage to grab their reserved Juggernaut, it has to battle through a much longer cpntested lane, taking much more damage before it threatens the attacker's Towers. This also means that the 'winning' team can semi-easily throw 4 Juggernauts down the lanes,; all while the defenders have no access to a Juggernaut of their own and are forced to send one of their teammates to defend a lane sieged by a lone Juggernaut *(putting them, at minimum, 4v5+Juggernaut)*.
	And it's with these Juggernauts that the already-oppressive winning team can stall time so they can complete the major boss that just spawned in - Apophis.
 - Apophis is the special Jungle Boss specifically for this mode ported in from Clash, lying closer to the Fire Giant than it does a Gold Fury. Defeat it, and you get a decent Power buff, and more importantly a huge regen buff - you essentially become unbeatable in a drawn-out fight. If you're struggling to end the game, Enhanced Apophis buff will additionally give all of your abilities a huge DoT, and make you deal a shitton of damage to Towers. Provided your team doesn't suicide *~~sadly, more likely than you want to see~~*, you pretty much cannot lose once you have Enhanced Apophis.
...
First herd of cats that manages to cleanly win a lategame teamfight wins the game.
 ...
 the gimmick of this mode are the Juggernauts, spawnable NPC's that can deal ranged damage and soak up a high amount of damage. 
   ...
   -> ![Slash Zones](https://files.catbox.moe/mpvmgb.png) <-
...
## -> Can I get a quick rundown on each God? Anything more complex? <- 
...
~~[Warriors](https://rentry.org/smgenQRD_Warrior)~~ |  | ~~[Guardians](https://rentry.org/smgenQRD_Guardian)~~
 | ~~[God Suggestions, for players coming from other MOBAs](https://rentry.org/smgenQRD_OtherMOBAs)~~ | 
...
The first thing you'll likely be greeted with, upon logging in for the first time, is an alert of about 15 quests and every bar saying there's *new content*! Don't worry about those, those are just your event weeklies that piled up in advance - they'll clear up within 2-3 games. There's also that Welcome Pass thing - it's cool, you'll finish it without realising, don't sweat it.
...
Now let me tell you what all those currency things do, then how you can game the ~~system~~ game:
 ...
 - ***Favor***
	The free and 'main' currency, earned through matches *(more from the first win of a particular gamemode each day)*.
	Used to purchase Gods, Recolors, Emotes and Mastery Skins. As of Season 9, this has been expanded to also be able to purchase Tier 2 Skins, Avatars, Viewer Points and Emote / Voicepack / Cosmetic Chests. See below for those.
	Generally speaking, you'll hit the 5,500 needed for the average God every week of playing, especially if you focus on your First-Win-of-the-Day bonuses in each gamemode and just do your weekly quests. New Gods are 11,000 only for the first few weeks they're available, and drop down later. You can also convert this stuff directly into Viewer Points and get a shitton from ~~ads~~, which we'll cover when we get to it.
	Advice on spending it = once you've got all the Gods, get all the Emotes. After that, the Emote Chest will be guaranteed-drop for Dances / Special Emotes; which are both great to have, is better than coughing up gems and cleans up a lot of filler in some chests. After that, it's up to you, with either Viewer Point conversion or clearing out the voice Pack Chest being the best 'use' of Favor.
 ...
 - ***Gems***
	...
	That's 2,600 Gems a year if you log in every day, excluding events. That's your F2P economy that you're going to be managing, with small bonuses here and there.
 ...
 - ***Viewer Points***
	...
	Encourages interaction with the SPL *(see below for not!betting advice)*; where you get 1,500 points per correct match outcome guess for most of the Season *(free to hedge a bet, but you can only go so far in advance, so you can't just log in once a year then bet on every match for the Season)*. Viewer Points are also generated by watching SPL streams if you link your / a Twitch Account, at a rate of 1,250 Points/4hr. *~~Best gamed by having a macro 'watch' ads for you in the background for infinite points + free chests; though leave a delay of ~1m between each one so you don't get caught fast.~~*
   As of Season 9, you can convert Favor into VP, 10k=10k. Unless you've sold your soul to the Ads, don't *(until you have all the playable Gods+Emotes)*, and if you have, focus on thinning out the 10k point cosmetic pool over the 75k skins first.

 - ***Worshippers & Mastery Level***
	Earned through matches, specific to a God - earning enough Worshipers will increase your Mastery Level for that God - Mastery Levels are needed to obtain Mastery skins.
   ...
   God Mastery does not increase past 10 (X) at 1,000 Worshippers, however each time you gain another 1,000 Worshippers, a Star is added to your God's Mastery Level. *There is no limit on these stars, and they do nothing.*
   Finally, there's a bonus mechanic, that unlocking Diamond Skins for purchase each give a point on your 'Diamond meter'. This is a long-term goal, but in short, the more Gods you Mastery 10, the more cool Diamond-y effect cosmetic shit you get.
...
Here's how to stretch your time / wallet the best:
 - First of all, you can pick up quite a few free bits and bats just by ***lurking*** for a while.
	...
	It's not much overall, but it's something and does add up.
 ...
 - ***Major Events / Odyssey's*** etc) hit a 'middle ground' *(if that's even a thing)*.
	These last 16 Patches + Bonus Patches, usually 2 each year. While expensive (~8,000-10,000 Gems), you're getting the most for your money out of them, on top of a Tier 5 skin (the highest-value ones), however the initial price in the 1,000's of gems really makes them hard sells. Even if you were to cough up your money for the most expensive Gem Pack on offer, it wouldn't cover the cost if you arrive to the event after most of the skins release *(since they're only 33% off while unreleased and their biweekly initial releases)*.
	They're the definite whale option, and aren't really designed to be accessible. If you game it as a F2P, you can get 1-2 skins off of them at a cheap price, and recoup some of the cost with some of the 'premium' event rewards after. Alternatively, if you appropriately strategise throughout the course of the entire event (patiently hitting the cheapest skins / bundles etc), you can usually get much of the pass and the Tier 5 itself for ~5,000 gems. That's still expensive, but noticeably less costly, in exchange for missing on some of the lesser skins.
...
## ->  The SPL (a.k.a. Who do I bet on in the Viewer Store?) <- 

 -> **[Mandatory Theme of the SPL. Do not read this section without this playing.](https://youtu.be/_B0CyOAO8y0)**  <- 

***

 -> ***HAVE YOU EVER BOUGHT HEARTWARD AMULET INTO 4 PHYSICAL DPS'S AND A FAFNIR SUPPORT?***  <- 
 -> ***HAVE YOU EVER THANATOS ULTED AN ULTING, FULL HEALTH XING TIAN?***  <- 
 -> ***HAVE YOU EVER LOST A GAME BECAUSE YOU WERE ASLEEP FOR THE DURATION OF IT?***  <- 
 -> *~~And those are the 'serious matches'.~~*  <- 
 -> *~~Don't make me pull out [this](https://youtu.be/gG1C1kn2h6M) 45 minute comedy act.~~*  <- 
 -> *~~Fun Fact: Most of the losers, and some of the winners are now playing as the Jade Dragons.~~*  <- 
 -> *~~Fun Fact #2: That match cost ~$5,000 in fines.~~*  <- 

 -> **WELCOME**  <- 
 -> **ONE AND ALL**  <- 
 -> **TO SMITE'S """"""PROFESSIONAL"""""" CIRCUIT**  <- 

 -> **WHERE EIGHT GROUPS OF ELITE SHITTERS COME TOGETHER TO PROVIDE DEEP AND SUPER SRS HIGH LEVEL GAMEPLAY FOR THE UNWASHED MASSES, AND A COMEDY ROUTINE FOR THE /SMGEN/TLEMEN, WHO UNDERSTAND WHAT THEY'RE WATCHING.**  <- 

tl;dr Autists (and not /our/ kind either). 
I'm going to keep this section short, sweet and barely relevant *~~(just like the SPL)~~*. If you just want betting advice, skip to the **bold** text.
*But Anon, I can see the Current Standings next to where I get to vote ri-*
They're inaccurate and never updated, ignore them.

Theoretically, the SPL makes up the highest level of SMITE gameplay. The devs pander to them in balance and leddit treats their word as gospel. Anyone can put together a team, compete in the weekly Open Circuit, rise up into the Challenger Circuit and then rise into the LAN-based SPL Circuit.
Thing is, people have lives. And so the only people who compete in the SPL are the kind of people who want to make money off of videogames for a living *(~$40,000/year last I heard)*. Or in other terms, 'people', who don't have lives.
I can say with absolute sincerity that there is a reasonable chance you can be mechanically better at the game than some of the players that le cummunity laud as GODS. We laugh at them all the time, and some of them are straight braindead. There have been multiple solo queue Grandmaster-level players in the gen of the years *(Top 50 / PC / NA and EU)* and considering that the SPL are 40 players large *(5 players per team)*, it puts into perspective the... 'quality' of the players. ~~And the overall quality of the /smgen/tlemen.... when they're not playing Zhong Support, Fafnir Mid, actually have their audio plugged in and don't have questionable Scylla / Jing Wei tabs open and distracting them.~~

So.
What makes the SPL a 'cut above the rest'? Well, it's the one thing you will never have ~~- friends~~ - communication. And a big ol' insular bubble separating their gameplay from the rest of the world.
Many people say that when you're new, you're playing a completely different game to when you're experienced. That applies again to the SPL - it's the difference between playing a game with and without reliable comms. To boil it down, they play ~~like bitches~~ extremely passively, focusing on structures and objectives, then use FG to teamwipe and win game in one push *(for example, it's not rare for a SPL Mid player to not go over 10-20k player damage; Jungle meta aside at any given time)*. Back on the ground, the game is played very differently. They unironically do not play the same game that we do, and you should not take their takes and meta too seriously - for the average player, the SPL is as far away from them as they are from Bronze-level play.
Oh, and if you think those comms or tactics are complex, you're dead wrong. Most of it goes along the lines of muttering and droning *"woah woah thoth low thoth low thoth low big yemoja ult woah woah lets do fury after woah yemoja low yemoja low rama coming in from duo come on yemoja on cooldown looking for arthur wheres arthur wheres arthur ult this thoth arthur coming in from solo*" or shit like that for 30 minutes straight. Listen in if you don't believe me, this isn't irony.

So how does an SPL match go? How do you watch an SPL game 'correctly'? What do you have to watch out for?
Simple - Gold.
SPL is all about Gold. If you want to see how a game is going, you look at the Gold difference, since everything going on on the map is all about dat Gold *(from teamfights, to objective contentions, to anything new added in after this is written)*. From there, just figure out yourself what's going on;
 - 0-1k Difference = Neck-and-Neck, could go either way.
 - 3k = Hard to recover.
 - 5k = The ones ahead can lose a full teamfight + Gold Fury unphased and still have the advantage.
 - 7-9k+ = It's over. The game is over. Would require a miracle to win.

So, upon approaching the SPL, you may wonder why you don't recognise the big ememesport names - where's MLG, Cloud9 etcetera? Thing is, when an org sponsers a team, the expect a cut of the profits. Ticket sales, tourney winnings, advertisement deals and so on.
So, one day, LoRez thought.... *"hey....what if we just take.... ALL the money?"*.
And so they did!
And now all the teams are in-house - as in, if you aren't situated in Alpharetta, Georgia, USA, you cannot play in the SPL. While this has done the groundbreaking achievement of keeping Koreans out of SMITE's ememesports, it also relegates EU and AU to play exclusively within SCC *(the competitive level down, that REALLY nobody watches)*, and has throttled a lot of it's growth outside of loyalty.

Anyways, all that said - ~~bets~~ predictions.
You get them for free, they cost nothing and you lose nothing. No gambling. While you can get into the nitty-gritty / sweaty sportsball-tier analysis, the SPL is split into the two parts *(kind like Demon Slayer / Kimetsu no Yaiba, if you're into weebshit)*.

 -> You've got the Upper half, and you've got the Lower half.  <- 
 ->  **In short: bet against the Lower Half, bet on the Upper Half, in that order.** <- 

Congratulations, you now have a ~75% correct prediction ratio, and have just got ~300,000 Viewer Points for free that year. When reading the following, keep in mind that higher amounts of games won isn't necessarily better - in a Best-of-3 Set, winning at 3-0 in 3 games is better than winning at 3-2 in 5 games.
In order of 'how good' they are, and how they did during Season 9 pre-Worlds / general takes:

 - Atlantis **LEVIATHANS** - Ended S9 at 35 sets at 60% winrate *(made of 103 games at 55% winrate)*.
	Reigning World Champion Team for S7 & S8 consecutively, and many of the players are from previous Seasons World Champions, from before the SPL went in-house teams. The SPL plays around the Leviashits, not the other way around, even the Kangz have some issues into them. Often lose early because they fuck around *(unironically)*, then shitstomp late anyways. Only team good enough they they can pull off insult-picks and laughspam, the only time they really lose is when this gets actually punished to fuck and back.
	Only difference coming into Season 10, they now have the the best Jungler in the world, *(who they dropped the second best Jungler in the world to get)* - meaning they now have the best Jungler (Adapting), ADC (Zapman) and Mid (Sheento) in the world on their team. As in, all three of their hardcarry DPS's are the best in the world, all of which are extremely aggressive and have histories of hardcarrying by themselves. Doesn't take much to join the dots. ~~Fun FACT: The ADC became a jew as self-punishment for losing a tournament a few years back~~
	Large passive following, if only for the reason most people don't pay attention to anyone but the best. 
 - Camelot **KANGZ** - Ended S9 at 36 sets at 78% winrate *(made of 124 games at 70% winrate)*. 
	In terms of W/L, this is the best established team in the SPL. All around solid lineup, with good players who are the best at general strategy / macro. Far from the best in terms of mechanical skill, but the Kangz prove why teamwork, comms and macro are so important at an SPL level. Very good in the Pick / Ban phase at strategically fucking over their mirror, by forcing them into overall bad choices. If Leviathans didn't exist, it wouldn't be a competition - otherwise, the two are pretty even into one another.
	The Kangz are also only team in the SPL where Pick / Ban phase is interesting to watch if you know what you're looking at - yet sadly once in-game, 'the best strategy' is playing like absolute pussies until late, then taking EFG and storming Titan. Boring as fuck to watch, sleeping is more entertaining than a Kangz match - these guys are worst example of SPLshittery and tryharding.
	Won Season 9 World Championships, basically just by gaming the Obelisk mechanic that was in the game at the time.

 -> *[MINOR POWERLEVEL GAP]* <- 

 - Highland **RAVENS** - *New to Season 10*
	Bolts got disbanded, leaving a new slot vacant in the Upper Four. Ravens seem to have got the best players from the breakups, including two of the Bolts, and the best Solo laner in the world, Haddix. Extremely aggressive teamcomp who all play well late and have decent macro; could easily seize a higher spot once they start playing depending on how well they actually play together *(ie Leviathans 2.0)*. While I can't speak for the gen's opinions on them yet, I'd personally say to keep an eye on these spergs, they might have some fun games to watch.
 - **STYX** Ferrymen - ~~*New to Season 10*~~ 38 sets at 52% winrate *(made of 123 games at 53% winrate)*.
	Titans got disbanded *(don't ask me why, I don't ~~know~~ care either)*, Ferrymen is pretty much just the new name for them *(previous 5th place shitters)*. Barely changed their roster, but got quite a few good players in place of who they lost *(namely Baskin, a well liked Solo laner Hongie Kongie - not the best, but he's cool)*
	Assuming they play almost the same as before, 'Underdog' is not the word to describe these clowns - more like 'salty spergs'. Best matchup knowledge into the other teams in the SPL, good teamwork, strategy and coordination, wanton actual gameplay. Most likely of the Lower Half to beat the Leviashits, but also most likely to lose to the Warriors. These fags win or lose at the Pick / Ban phase, and don't do their research on the rest of the Lower Half (in the hopes the better teams knock them out for them). Good Mid player

 -> [POWERLEVEL GAP] <- 

 - Jade **DRAGONS** - Ended S9 at 37 sets at 51% winrate *(made of 116 games at 51% winrate)*.
	Long story short, this isn't actually the Jade Dragons from S9 *(previously #4)*, it's the Oni Warriors *(previously#6)* rebranding themselves under a more successful team name. Maybe they think it'll change things, but realistically it's not going to do shit for their previous performance.
	Very good players who can't play anything other than their main. Regularly will start a game strong, then finds some ingenious way to choke and throw. Usually lose at the Pick / Ban phase. Other than that, they do now have the best Support player in the SPL now *(PolarBearMike, the only guy who actually was on the previous Jade Dragons)*, but it's not going to save them from getting walled at the Pick / Ban phase, and their communication is yet to be seen.
	*Hey, at least they're at #5 now. ~~Not as much because they got better, but because the ones above them dropped out, but still.~~*
 - Oni **WARRIORS** - *New to Season 10*
	The previous Oni Warriors didn't want the name any more, so these guys took it.
	Absolute shotgun-to-a-barn-door in terms of players. Pretty much what happened, is that all of the top teams dropped their worst players in time for Season 10, and this is the cope-squad that was thrown out. The only good player is their Jungler *(Panitom, a hype-as-fuck player who hardcarried a shitton of games for the Leviathans)*, but not even Atlas could carry this team on their shoulders. Highly likely they're going to have shit comms, shit co-ordination and shit teamwork; even if they're all individually all ex-top players. In fact, considering why most of these players were dropped to begin with, it's almost certain.

 -> [POWERLEVEL GAP] <- 

 - Eldritch **HOUNDS** - *New to Season 10*
	Valkyries and Scarabs ~~seppuku'd~~ disbanded ~~in shame~~, and so the SPL needs two new teams of jobbers. This band of plucky shitters look to be seizing the Scarabs spot in 7th. Entire team has mostly newfag players that can clutch out l33t epikk plays, but are shit at the actual neutral game. Will probably feature in more highlight clips than actual wins. Only saving grace is that their coach is a multiple-time World Champion, so depending on how they learn from their losses, might actually move up a bit.
	As in this time next year, not any time soon. You should still bet against them. Expect a ~20% winrate *(if that)* for now, if we're going by the logic that they're filling in for where the Scarabs jobbed off.
 - Gilded **GLADIATORS** - *New to Season 10*
	Long story short with these pieces of shit; went from *(an extraordinarly rare)* /smgen/ fave, to the internally most viciously hated team in the SPL over here.
	Initially appeared to be a true underdog team, made up of newfags to the scene *(which is pretty rare)*, /smgen/ was marginally interested. Once their ADC got them qualified, they dropped him for doing a single, out-of-context racism 4 years prior, before he was even involved in the SPL, with a non-personal twitter account *(even though they already knew about it, and were fine with him getting them qualified)*. That might have been out of their control *(the tw@ter mob & LoRez being staunchly anti-Freedom of Speech being to blame for him getting cancelled ~~Freedom of Speech, a relatively well-liked concept on 4chan~~)*, but [officially gloating over one of their players / teammates having his life ruined](https://twitter.com/SPLGladiators/status/1631759006468325378) wasn't.
	Expect people in the gen to watch their games, just to watch them lose. Fuck em. As a positive (for us), they're the lowest rated team in the entire SPL *(even before they lost their ADC)*, so expect them to lose every single game. Going off of the Valkyries's performance *(the previous lowest winrate team in the SPL)*, expect a sub-15% winrate.
	Never bet on them, and you'll be rolling in those Viewer Points - you're more likely to win by betting *\*against*\* these guys than betting *\*on*\* the 'top teams'.

\>But Anon, what about the times when the weird names pop up?
Those are the SCC teams / Non-NA teams, who have qualified to play with the Big Boys for one of the tri-yearly larger Tourneys. All of them are shit and get their shit pushed in by the 24/7 career SPL players, unless they're playing against the Lower Half, in which case they have a chance *(usually you'll see the Eldritch Hounds, Highland Ravens or Hex Mambo)*.
This is also why 'the rule' is to bet against the Lower Half, bet on the Upper Half, in that order.

***

## -> Lore & Default Splash Art Galleries <-

For your reading pleasure, I have contained all relevant mythological contexts, game-narrative and general map-history / game-history autism into this.... 'brief' doc.
...
~ - ~ - ~ - ~ - ~ - ~ - ~ - ~ - ~ - ~  | All Best-Posssible-Quality God Splash and Concept Art by Pantheon | ~ - ~ - ~ - ~ - ~ - ~ - ~ - ~ - ~ - ~ 
:----: | :----: | :----:
...
>Datamining *(Low Information - often whichever FotM twitterfag is leaking has more detail, but you'll need to lurk for that)*
https://smitedatamining.com

>The Word of Thoth
A very in-depth manual on all game mechanics *(much better than the in-game Glossary if you have any thoughts, but I have got most of it covered within this doc)*
www.wordofthoth.com 
 
>Overarching Guides
Extremely in-depth guides that almost fully detail the 'meta' of each role within each gamemode. Don't worry if you're overwhelmed (it should), don't bother if you're so new you have no idea what they're even talking about, and don't take it all at face value (as usual across every game in vidya, meta is a spook)
- Conquest:
...
>Online Version of The Pantheon War *(See Loredoc for more)*
...
https://youtube.com/user/smitegame
https://facebook.com/smitegame
https://instagram.com/smitegame

>\>"How2make / contribute OC?"
 - For videos, Webm4retards *(or Windows MovieMaker) (or VEGAS if you can ~~torrent~~ acquire it legitimately)*
...
For filesizes, Encoding > Size Limit > 4MB; and Processing > Resize > *(Bigger Width = Lower Quality; Smaller = Smaller) (Anywhere between 480 to 720p wide should do you)*.

 - For images, anything from Photoshop, to GIMP, to paint.net. Photoshop has the most but is closed-source / requires torrenting, GIMP is opensauce but takes a solid while to learn, paint.net is extremely easy to use and 'good enough' but lacks comfort features like custom brushes or text boxes.

 - For uploading, usually streamable.com. You can use a fake email to sign up ({whateverthefuckyouwant}maildrop.com), and while it whines that it'll delete links after a few months, it usually lasks a while longer. Catbox / Pomf if you just want to drag+drop an upload (or uploading images) without having to bother with sign-ins, at the downside that they take a while to load.
