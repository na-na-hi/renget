i-> ![SMGEN](https://files.catbox.moe/ksdeqy.png) <-
...
That said, I'm not here to give SMITE a handjob - it lacks the mass-popularity of League, and the ultra-autism complexity, depth and macro of DotA 2. *While there are some complex kits to sink your teeth into, it doesn't have any 'extraordinarily' complex kits; such as the Invoker, Arc Warden or Meepo from DotA 2, nor does it have anything like the 200-years Aphelios of LoL .... Yet. ~~/ any more, RIP pre-Rework Persephone / Hydra's Set~~*. You are not going to impress needy, fatherless, groomable e-girls by playing it, and you're not going to garner the respect of the elder-neckbeards for being good at it. It occupies a middle-ground between DotA 2 and LoL in many ways *(closer to LoL)*, while doing many things completely unique by itself. To say the very least, it's no copycat.
If you're moving over from LoL or DotA 2, there will probably be a few Gods that you're comfortable with *(for example; Maui hits a lot of Thresh's notes, while Artemis and Neith are two aspects of Sniper)* - just ask for comparisons within the thread if you want more detailing, ~~or see the dedicated bit for it when it's done~~.
While there are many other differences that really set it apart from the body of the genre *(Longer TTK, Lasthitting / CS being much harder, Minions having times when they can hit like trucks if left unchecked etc)*, you'll just need to learn them with experience - I wouldn't have enough time to detail them all.
...
### Before a game
 1. Jump straight the fuck into Jungle Training / Practice. It's a Godsend of a mode, and has everything you could ever want while new. Try a few Gods, but most importantly, mess around with your Sensitivity and HUD until you're comfortable.
	...
	- Casting Mode is the debate of our age.
		 ...
		 - Instant Casting gives minimal delay but immediate investment, and is the 'default' for more experienced players. Don't feel the need to go overboard with it, as some abilites have benefits to aiming *(Vulcan Ult as the prime example, since on Instant it won't go further than 55 Units)*, however you'll want to use this as much as reasonably possible.

		Finally, if you do so desire, you can also change casting styles on a per-Ability basis (Menu -> Abilities), for when one casting mode is especially useful - such as having Instant Cast on escape abilities *(which you don't need to see a reticle for)*. On the other hand, your 'default' casting style; regardless of what your abilities asigned to in the menu, will dictate how your wards and relics are used across all Gods, and as a result, I highly recommend at least having it set to Quick or Instant *(depending on if you prefer to carefully place Wards, or want immediate Sundering Spears)*, and then customising Abilities accordingly.
	...
	- Other recommended options;
		 ...
		 - No Reticle because it's useless visual clutter.
 ...
 4. If you plan on playing a God, try to make an item loadout for yourself in advance; even if you're just duplicating somebody else's *(in TCG terms, netdecking)*. You don't want to be spending valuable time lingering in spawn picking and choosing what to build, and if you're new, you probably won't know what's good for your God pick or what's meta - with a good chance of accidentally hitting a stat cap *(e.g. trying to go above 40% Cooldown Reduction)* and wasting Gold. While ones you'll find online may lack detail or personal taste; in terms of getting you the basics for a God, they do help;
	...
	- The first 3-4 items you take should make up the body or 'core' of your build.
		While pre-choosing a 5th and 6th item is useful for a 'smooth game', the simple fact is that many games don't even last that long, and those slots are often reserved for counterbuilding, or for one of your core items to be built later if you needed an important counterbuilding item ASAP *(such as the always-important-if-present AntiHeal)*
...
###During a game 
 ...
 5. On the topic of Towers - if you attack an enemy God under a structure, the structure will ignore any Minions (not Gods) damaging it, and attack you - *which is why you should decide if you're going to either attack / destroy the tower, or bite the bullet and attack the God defending it while eating some tower shots. Not both at once*. If two Gods damage an enemy under their structure, it will 'remember', and will focus on the second once the first is dealt with.
    Aside from this, a structure will not change aggro until it's target is either dead or out of range. Structure Attacks are auto-aim, auto-tracking and will *always* strike once fired *(even if you teleport across the map, like with Athena's Ult)*. If all minions die under a structure, it will default to the closest enemy God.
 ...
 7. Get familiar with the ingame voice-command-system (VGS System), which you can use to issue commands such as setting up a gank, calling for defence, or pointing out a MIA enemy from your lane (who might be roaming around). Hit V on your keyboard (or if on controller, Right on your D-pad) to bring up the list and the corresponding prompts to call out what you like. The VGS system has a bit of a skill floor, but is worthwhile to learn, and everything you could ever need to say is *somewhere* in it.
	...
	- For the special map pings ~~that people use exclusively when raging~~; PC just needs to click the map, while Controller holds the Right D-Pad button for a few seconds to bring up the minimap and do it that way.
...
**And finally / most importantly**
 9. **Calm down with the aggro.** The major newfag mistake is playing way too aggressively, and needlessly dying. Trading deaths is ~~usually~~ not a viable strategy in SMITE (or MOBA's in general), as you'll be putting increased strain on all your teammates, as the enemies get a passive Gold and EXP boost *(on top of fighting 5v4's)*. This is a genre where a difference of 3+ levels is a pretty difficult task to play into.
	...
	While this becomes more irrelevant later on; once you begin to get some combined gamesense as for how aggressive you can be, the difference between bad enemy positioning and them baiting you, and when you should poke for kills - in your early-learning phase you should really just play more passively.
...
*I'm going to make this as painless as I possibly can. You'll hear a lot of stuff you already know, but I have to lay everything out, as there's quite a lot of stuff that's either hidden or confusing.*
 ...
 - Power
	...
	- There is no 'hardcap' to Power or Damage. The only cap that exists is the Item Power cap, preventing you from going over 400 Physical Power or 800 Magical Power respectively, via the base Power stats of your Items.
 ...
 - Attack Speed
	...
	- Using a Relic will not reset a Basic Attack Chain. This is most iconically done with a Blink Rune to perform a 'Blinkbasic' - where a Melee God with an extremely high damage Basic Attack multiplier within their chain *(eg Serqet, Ne Zha, Thanatos, Loki, Guan Yu)* will attack the air for a few seconds from out of range to progress to that heavy Basic, then blink to their target, instantly performing the highest damage attack in their chain.
		When combined with an AAcancel chain, this is known as a Blinkchain. This is can paired with Crit, in an attempt to score a oneshot kill.
	- Relic Shards will not activate while a Basic Attack is being performed. It's stupid, but it's just how it works - you can't Wing Shard or Carapace Shard while holding Basic Attack, you need to take your finger off the input, then activate the Shard.
 ...
 - Protections / 'Prots'
   ...
   - Long Answer:
         ...
         - Unlike Power, the Prot Caps of 325 cannot be exceeded via most conventional means. Flat Prot Passives, any Flat Prot Buffs from Abilities, Item Effects, Potions, Jungle Buffs and any other God's Abilities or Auras will NOT allow a God to exceed the Prot cap.
			The only way to break the Prot Cap is to be under the effect of a % increase during an Ability or Item Effect. For the most 'common' example of this extremely niche scenario, if a Support Sobek or Hades ends the game while Ulting, you may see in the post-match screen that they will have exceeded their Prot caps, as their Ult gives them an unconditional % increase to their Prots. Alternatively, both Corrupted Bluestone and Eldritch Dagger allows a God to exceed 325.
 ...
 - Damage Mitigation / 'Mits'
	...
	-  In Season 10, the entire Mitigations mechanic was overhauled.
		...
		*~~Ironically, this calculation change was introduced because complete fucking retards thought they could hit a value of 100% Mitigation with the previous calculation, and complained extremely loudly - when instead they were factually wrong and just hit a high number, then healed the rest of the small amounts of incoming damage to appear that they were immune. Turns out nobody can do basic percentile mathematics I guess. Or that clickbait is very effective at riling up a crowd.~~*
	...
	- While Damage Mitigations / Reductions are almost always in % *(previously to keep it balanced / to prevent 100% mitigations)*, there does exist Flat Reduction, which will reduce damage taken by that set amount under the same logic as Mitigations, from ALL individual sources of damage.
		*For example - you get hit by Ah Puch's Antiheal Grenade, and because you healed, you're in for two instances of damage. Each instance would be reduced by the Flat Reduction. Additionally, if he's built Soul Reaver and you're hit with the Item Passive, that too is also reduced by the Flat Reduction. Additionally, he's also built Conduit Gem, and you're hit with the True Damage Item Passive on that..... that too is also reduced by the Flat Reduction. On one Ability, the Flat Reduction applies to all 4 instances of unique damage sources individually, for x4 the indicated value.*
		As of writing Flat Reduction only exists on one Item, no God Abilities, and is extremely small - and despite this, it is the most potentially valuable and game-breaking stat in the game if left to balance oversight. ~~Can you find it?~~
 ...
 - Movement
	...
	- This is only for your default 'running around'. Dedicated Movement Abilities such as Dashes operate on a different formula, however channelled 'Charges' *(eg Chiron's gallop, Charon's speed-row)* do not, and can cap at 754.
	...
	- The slowest Gods in the game (who have no additional Combat Movement) are Hel and Nu Wa, each moving at 5.41m/s.
...
## -> Additional Jargon Glossary *(of the stuff you actually want to know, and are not told)* <-
 ...
 - Front-to-Back / Back-to-Front = The two ways a team can approach a teamfight. Both have upsides and downsides.
	- Front-to-Back is also known as 'Deathball', where one team will focus on the Tanks first to reach an undefended low-health backline.
...
As for any other things to know:
 ...
 - Gods with good combat mobility thrive at getting EZPZ kills in this mode - Gods like Bastet, Hun Batz and Susano do well in Arena, with their ability to get in and out within one Ability rotation and picking off choice targets from anywhere on the map.
...
Since you can't really choose, there isn't a 'meta' teamcomp. In terms of gameplay, you'll usually have an emote-off until minions spawn, each side will poke at each other for a bit until you get strong enough to bust a Tower (~Lv8-10); then it's a tug of war of teamfights as both teams try to barrel through the Titan ASAP. Really not complicated.
...
Now let me tell you what all those currency things do, then how you can game the ~~system~~ game:
 ...
 - ***Favor***
	...
	Used to purchase Gods, Recolors, Emotes and Mastery Skins. As of Season 9, it was expanded to also be able to purchase Tier 2 Skins, Avatars, Viewer Points and Emote / Voicepack / Cosmetic Chests. See below for those.
	...
	Advice on spending it = once you've got all the Gods, get all the Emotes. After that, the Emote Chest will be guaranteed-drop for Dances / Special Emotes; which are both great to have, and is better than coughing up gems and cleans up a lot of filler in some chests. After that, it's up to you, with either Viewer Point conversion or clearing out the voice Pack Chest being the best 'use' of Favor.
 ...
 - ***Viewer Points***
   ...
   As of Season 9, you can convert Favor into VP, 10k=10k. Unless you've sold your soul to the Ads, don't *(at least until you have all the playable Gods+Emotes)*, and if you have, focus on thinning out the 10k point cosmetic pool over the 75k skins first.

 - ***Worshippers & Mastery Level***
	Earned through matches, specific to a God - earning enough Worshippers will increase your Mastery Level for that God - Mastery Levels are needed to obtain Mastery skins.
   ...
   Finally, there's a bonus mechanic, that unlocking Diamond Skins for purchase each give a point on your 'Diamond meter'. This is a long-term goal, but in short, the more Gods you get to Mastery 10, the more cool Diamond-y effect cosmetic shit you get.
...
Here's how to stretch your time / wallet the best:
 ...
 - The ***worst value for money are easily the chests***, worse yet the ones with huge pools in the 100's.
	While some are kind enough to have a pity mechanic *(burn a hole in your wallet and open 5 to tick the boxes so you get to choose the 6th skin... but you're still paying for it though)*, they are still ultimately random, and there's far higher chance you'll get a contextual stinker for a God you don't play. Chests are the Blue Whale option, and even if your main God gets a new skin, it's best to wait for the chest that it's in to go on sale, rather than buying it in the first patch it releases with. Regardless however, keep your eye on the store - sometimes there are great deals on small-pool chests (the 6-12 skin ones), where if you like everything inside, you can just treat it as a glorified bundle. If you've been here a while, and sold your soul to the ads, you may have passively thinned out a few chests, so there's a higher chance of getting the new stuff in it too.
...
>Datamining *(Low Information - FotM twitterfags usually datamine more detailed stuff, but you'll need to lurk for that)*
...
For filesizes, Encoding > Size Limit > 4MB; and Processing > Resize > *(Bigger Width = Lower Quality; Smaller = Smaller) (Anywhere between 480 to 720p wide should do you)*.
 ...
 - For uploading, usually streamable.com. You can use a fake email to sign up ({whateverthefuckyouwant@maildrop.com), and while it whines that it'll delete links after a few months, it usually lasks a good while longer. Catbox if you just want to drag+drop an upload (or uploading images) without having to bother with sign-ins, at the downside that they take a while to load.