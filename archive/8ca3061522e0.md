...
!!! note Last update: 02/01/2024 [Old Pastebin info (Last edited Apr 24th, 2013)](https://pastebin.com/5sKRiJzS)
!!! info
    Don't shy away, write your thoughts and suggestions about this page presentation and its contents at our usual [/vr/ congregation place](https://boards.4chan.org/vr/catalog#s=DOOM%20THREAD).
## Table of contents
***
[TOC3]
### Main article
...
**`100 minutes of /vr/`**: [idgames](https://www.doomworld.com/idgames/levels/doom2/Ports/0-9/100minvr), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=100_minutes_of_vr), [DSDA](https://dsdarchive.com/wads/100minvr), [Doomshack](https://Doomshack.org/uploads/100minvr.zip), [MediaFire](https://www.mediafire.com/folder/rwyeezbv3qi3m) **-complevel 9** [December 2018]
**`200 minutes of /vr/`**: [idgames](https://www.doomworld.com/idgames/levels/doom2/megawads/200minvr), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=200_minutes_of_vr), [DSDA](https://dsdarchive.com/wads/200minvr), [Doomshack](https://Doomshack.org/uploads/200minvr.zip), [MediaFire](https://www.mediafire.com/folder/rwyeezbv3qi3m) **-complevel 2** [June 2014]
**`300 minutes of /vr/`**: [idgames](https://www.doomworld.com/idgames/levels/doom2/megawads/300minvr), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=300_minutes_of_vr), [DSDA](https://dsdarchive.com/wads/300minvr), [Doomshack](https://Doomshack.org/uploads/300minvr.zip), [MediaFire](https://www.mediafire.com/folder/rwyeezbv3qi3m) **-complevel 2** [September 2017]
**`400 minutes of /vr/`**: [idgames](https://www.doomworld.com/idgames/levels/doom2/Ports/megawads/400minvr), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=400_minutes_of_vr), [DSDA](https://dsdarchive.com/wads/400minvr), [Doomshack](https://Doomshack.org/uploads/400minvr.zip), [MediaFire](https://www.mediafire.com/folder/rwyeezbv3qi3m) **-complevel 9** [May 2022] 
...
**`2048 units of /vr/`**: [idgames](https://www.doomworld.com/idgames/levels/doom2/Ports/megawads/2048vr_v1.6g), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=2048_units_of_vr), [Doomshack](https://Doomshack.org/uploads/2048vr_v1.6g.zip), [MediaFire](https://www.mediafire.com/folder/er08f62xtlmld) **-complevel 11**
...
**`2048 guns, brightmaps add-ons (ZDoom)`**: [idgames](https://www.doomworld.com/idgames/combos/2048guns), [Doomshack](https://Doomshack.org/uploads/2048guns.zip), [MediaFire](https://www.mediafire.com/folder/er08f62xtlmld)
**`2048 guns vanilla add-on (Vanilla)`**: [TSPG](https://static.allfearthesentinel.com/wads/2048guns_dehacked_edition_v4.wad), [Doomshack](https://doomshack.org/uploads/2048guns_dehacked_edition_v4.wad), [MediaFire](https://www.mediafire.com/folder/er08f62xtlmld)
...
**`512 linedefs of /vr/`**: [idgames](https://www.doomworld.com/idgames/levels/doom2/Ports/megawads/512linesvr), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=512_linedefs_of_vr), [DSDA](https://dsdarchive.com/wads/512linesvr), [Doomshack](https://Doomshack.org/uploads/512linesvr.zip), [Catbox](https://files.catbox.moe/833nxi.zip) **-complevel 9**
...
**`HFFM (Cut version)`**: [MEGA](https://mega.nz/folder/QHI3SACC#j7tH7hh9d1fhgA99_OkgSQ), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=hffm), [MediaFire](https://www.mediafire.com/folder/i7j0ayyaj0d9w), [Catbox](https://files.catbox.moe/vfuup0.zip) (Slightly censored) **-complevel 9**
**`HFFM (Uncut version)`**: [MEGA](https://mega.nz/folder/QHI3SACC#j7tH7hh9d1fhgA99_OkgSQ), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=hffm), [MediaFire](https://www.mediafire.com/folder/i7j0ayyaj0d9w), [Catbox](https://files.catbox.moe/5pofdt.zip) (Uncensored) **-complevel 9**
**`HFFM (Gagged version)`**: [MEGA](https://mega.nz/folder/QHI3SACC#j7tH7hh9d1fhgA99_OkgSQ), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=hffm), [MediaFire](https://www.mediafire.com/folder/i7j0ayyaj0d9w), [Catbox](https://files.catbox.moe/1lwyti.zip) (Uncensored, removed sound effects) **-complevel 9**
**`HFFM (Stripped version)`**: [MEGA](https://mega.nz/folder/QHI3SACC#j7tH7hh9d1fhgA99_OkgSQ), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=hffm), [MediaFire](https://www.mediafire.com/folder/i7j0ayyaj0d9w), [Catbox](https://files.catbox.moe/zou58n.zip) (Bare levels, removed sounds and cosmetics) **-complevel 9**
**`Party Pack add-on (Vanilla)`**: [MEGA](https://mega.nz/folder/QHI3SACC#j7tH7hh9d1fhgA99_OkgSQ), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=hffm), [MediaFire](https://www.mediafire.com/folder/i7j0ayyaj0d9w), [Catbox](https://files.catbox.moe/xdzwuv.zip) (HFFM sounds and cosmetics to mix with other wads)
**`Party Pack add-on (ZDoom)`**: [MEGA](https://mega.nz/folder/QHI3SACC#j7tH7hh9d1fhgA99_OkgSQ), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=hffm), [MediaFire](https://www.mediafire.com/folder/i7j0ayyaj0d9w), [Catbox](https://files.catbox.moe/tp3xpe.zip)
!!! note
    **Ad Mortem** (MBF21-compatible, DOOM2.WAD) [October 2021], [DoomWiki page](https://doomwiki.org/wiki/AD_MORTEM)
![Ad Mortem](https://i.postimg.cc/52cgS6PX/ad-mortem.png)

*Halloween-themed, full of whimsical macabre. Exquisite weaponry to slay horrors with included.*
Final update is soon to creep in...

**`Ad Mortem`**: [MEGA](https://mega.nz/folder/e7Al3RyJ#5wvEjr9AupzvZzTcYDqFzg), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=admortem&s[]=ad&s[]=mortem), [Doomshack](https://doomshack.org/uploads/ADMORTEM_v5.1.zip) **-complevel 21**
!!! warning
...
*"In a world where there are no apparitions to agitate, no bones to bamboozle, all shall remain... unrattled."*
...
!!! Warning
    **Fore/vr/ Alone** (==**In development**==, Boom-compatible, DOOM2.WAD) [~~June 2023~~ Soon] [DoomWiki page](https://doomwiki.org/wiki/Fore/vr/_Alone)
![So ronery](https://i.postimg.cc/jqFZNbJS/ashit.gif)

*"Records of a longest pilgrimage, in search of ephemeral made eternal"*
With a lost prelude of Mokou-anon getting up on his feet, be well.

**`Beta version`**: [Doomshack](https://doomshack.org/uploads/frvrlone_beta1.zip), [MediaFire](https://www.mediafire.com/file/3sikjb9zwhy7s4m), [Catbox](https://files.catbox.moe/u9smv4.zip) **-complevel 9**
!!! Warning
...
Making maps on top of Doom 2 retained monster placement.
Be sure to check for already claimed maps in [the thread](https://boards.4chan.org/vr/catalog#s=DOOM%20THREAD).

**`Cleaned up Doom 2 maps`**: [Catbox](https://files.catbox.moe/rvp7ap.zip)
**`Submission rules`**: [Pastebin](https://pastebin.com/CrVTqGvr) **Deadline:** ==February 16th==
!!! note
...
**`HUH`**: [Quaddicted](https://www.quaddicted.com/reviews/huh_final.html), [MediaFire](https://www.mediafire.com/file/tnq44w6uqqrd41q/huh_final.zip/file), [Catbox](https://files.catbox.moe/hdoezv.zip)
!!! warning
...
**`Mapping kit`**: [MEGA](https://mega.nz/folder/LVlWVK5D#H5iqeD61bSItMIVeGqymTQ)
**`First release`**: [Quaddicted](https://www.quaddicted.com/reviews/vr1_00.2.html), [ModDB](https://www.moddb.com/mods/violent-rumble)
#### Build engine
***
!!! note
...
!!! warning
    **Sum Ting /vr/y Wong** (==**In development**==, WangGDX, VoidSW, Raze)
![Sum Ting /vr/y Wong](https://i.postimg.cc/CMbgjxxM/sum-ting-vry-wong.png)

Where are shaolin mappin skillz you chicken shit?!

**`Mapping kit`**: [Internet Archive](https://archive.org/details/shadow-warrior-mapping-kit)
**`Submission rules`**: [Postimages](https://i.postimg.cc/0jVqpGBF/sw-rules.jpg) **Deadline:** ==July 27th==
#### Uncategorized
***
!!! warning
...
It's time to get **serious**, read the rules and check for updates in [the thread](https://boards.4chan.org/vr/catalog#s=DOOM%20THREAD).
There is also a lovingly made jump-start mapping tutorial by yours truly:

**`Mapping tutorial`**: [Rentry](https://rentry.org/vy4qr)
...
##Level packs -> <-
-> [![Nanka Kurashiki](https://i.postimg.cc/KY68s5sT/52882200-p0.png)](https://www.pixiv.net/en/users/5143909) <-
...
[Hopscotch](https://doomwiki.org/wiki/Hopscotch) (MBF21-compatible) | [LunchLunch](https://doomwiki.org/wiki/LunchLunch) | Doom | [idgames](https://www.doomworld.com/idgames/levels/doom2/Ports/megawads/hopscotch), [DSDA](https://dsdarchive.com/wads/hopscotch), [Doomshack](https://doomshack.org/uploads/hopscotch.zip), [Catbox](https://files.catbox.moe/aqwlrl.zip)
Infernal Immolation (Vanilla) ==Beta== | Anonymous | Doom | [Doomshack](https://doomshack.org/uploads/infimmo_beta5.zip), [MediaFire](https://www.mediafire.com/file/11svir2wa9z5ccf), [Catbox](https://files.catbox.moe/accz9z.zip)
[Machete](https://doomwiki.org/wiki/Machete) (Boom-compatible) | [A2Rob](https://doomwiki.org/wiki/A2Rob) | Doom | [idgames](https://www.doomworld.com/idgames/levels/doom2/Ports/megawads/machetefinal), [WadsUp](http://clovr.xyz/wadsup/doku.php?id=machete), [DSDA](https://dsdarchive.com/wads/machetefinal), [Doomshack](https://doomshack.org/uploads/machetefinal.zip), [Catbox](https://files.catbox.moe/5wbu62.zip)
...
Of Myth Relinquished (Limit-removing) ==Demo episode== | Various | Heretic | [Dropbox](https://www.dropbox.com/s/w1ytvkv2dqo10cq/HereticLRP_OMRv3.wad?dl=1), [MediaFire](https://www.mediafire.com/file/x3xppfgku560vzk), [Catbox](https://files.catbox.moe/0jlu1b.wad)
...
Rise of the Triangles (Vanilla) ==Release candidate== ⭐| Anonymous | Doom | [WadsUp](http://clovr.xyz/wadsup/doku.php?id=rise_of_the_triangles_rc1), [Doomshack](https://doomshack.org/uploads/rottriangle_RC1.zip), [MediaFire](https://www.mediafire.com/file/en09okeoxuhpvj9), [Catbox](https://files.catbox.moe/ucy753.zip)
...
##Mods -> <-
-> [![DAKKA](https://i.postimg.cc/52RnFH6y/DAKKA-Players.png)](https://jinotra.in/mods) <-
Project | Author | Engine | Download links
------ | ------ | ------ | ------
Babel (GZDoom) | Xangi | Doom | [itch.io](https://datanon.itch.io/babel)
Bring Your Own Class (Zandronum and GZDoom) | Various | Doom | [itch.io](https://revenatn.itch.io/byoc)
...
'D' Radys (ZDoom) | [Toooooasty](https://doomwiki.org/wiki/Toooooasty) | Doom | [Doomshack](https://doomshack.org/uploads/d-radys_v62_fix.zip), [MediaFire](https://www.mediafire.com/file/cy98kfrhkf3nkig), [Catbox](https://files.catbox.moe/dmqos7.zip) (v62)
...
[Golden Souls](https://doomwiki.org/wiki/Doom:_The_Golden_Souls), [Castlevania: Simon's Destiny](https://doomwiki.org/wiki/Castlevania:_Simon%27s_Destiny) (GZDoom) | [Batandy](https://doomwiki.org/wiki/Batandy) | Doom | [Itch.io](https://batandy.itch.io/)
...
***
->[![](https://i.postimg.cc/c4SnLw64/wadsup.png)](http://clovr.xyz/wadsup/)<-
